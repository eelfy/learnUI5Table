/*global QUnit */
sap.ui.define(["sap/fe/navigation/PresentationVariant", "sap/fe/navigation/NavError"], function(PresentationVariant, NavError) {
	"use strict";

	/**
	 * tests for the sap.fe.navigation.PresentationVariant class
	 */
	...
	QUnit.test("get/setContextUrl: identity when reading/writing", function(assert) {
		...
		assert.equal(
			this._oPresentVar.getContextUrl(),
	...
	QUnit.test("parseFromString: Simple Deserialization", function(assert) {
		...
		var effectiveString =
			'{"Version":{"Major":"1","Minor":"0","Patch":"0"},"PresentationVariantID":"test-id_1234-toJSONString","ContextUrl":"/sap/opu/odata/myOdataService//$metadata#AccountBalanceQueryResult","Text":"test text for toJSONString check","a":"A","b":"B","c":"C","Visualizations":[{"t_a":"A","t_b":"B","t_c":"C"},{"Type":"Chart","c_a":"A","c_b":"B","c_c":"C"}]}';
