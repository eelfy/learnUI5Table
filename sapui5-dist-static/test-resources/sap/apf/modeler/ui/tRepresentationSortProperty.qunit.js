...
sap.ui.define([
	...
	'use strict';
	var spyOnConfigEditorSetIsUnsaved, spyOnParentStepRemoveOrderBy, spyFireEvent, oRepresentationSortPropertyView, spyOnGetText, oModelerInstance, oStepPropertyMetadataHandler;
	...
	function _commonSpiesForTest(oParentStepObject) {
		...
		sinon.spy(oModelerInstance.unsavedStepWithFilterMapping.getRepresentations()[0], "removeAllOrderbySpecs");
		sinon.spy(oModelerInstance.unsavedStepWithFilterMapping.getRepresentations()[0], "addOrderbySpec");
	}
