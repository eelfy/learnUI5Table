			...
			"Setup " + WCAType,
			{
				...
				beforeEach : function(assert) {
					...
					this.mapTextsFromRessourceBundleToTextPool = function(textKeyObjects) {
						var that = this, result = new sap.apf.utils.Hashtable(this.messageHandler), uniqueTextKeyObjects = [], ht = new sap.apf.utils.Hashtable(this.messageHandler), htPath = new sap.apf.utils.Hashtable(this.messageHandler), textElements, i;
