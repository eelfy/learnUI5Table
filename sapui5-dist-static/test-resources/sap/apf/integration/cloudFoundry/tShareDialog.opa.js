...
sap.ui.define([
...
], function (Mockserver, APFServiceMockServer, sinon, LaunchPageUtils) {
	"use strict";
	...
	QUnit.module("Share Dialog", {
		beforeEach: function () {
			...
			this.iFrame = sap.ui.test.Opa5.getWindow();
		},
		afterEach: function () {
	...
	opaTest("Start Modeler", function(Given, When, Then) {
		Given.iStartMyAppInAFrame('../../testhelper/modelerComponentCloudFoundry/index.html?sap-ui-language=EN#/app/57FCA36EC3D350DEE10000000A442AF5/config/15184393783558433132010203955379');
		Then.waitFor({
			success: function () {
