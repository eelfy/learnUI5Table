...
sap.ui.define([
...
], function (Mockserver, APFServiceMockServer, ValueHelpMockServer, sinon) {
    "use strict";
    ...
    opaTest("Should start the Modeler", function (Given, When, Then) {
        // Arrangements
        Given.iStartMyAppInAFrame('../../testhelper/modelerComponentCloudFoundry/index.html?sap-ui-language=EN#/app/57FCA36EC3D350DEE10000000A442AF5/config/15184393783558433132010203955379/category/Category-1/step/Step-1');
        Then.waitFor({
            success: function () {
