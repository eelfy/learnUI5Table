...
sap.ui.define([
	...
	QUnit.test("Test the SAPUI content Density", function (assert) {

		assert.equal(document.body.classList[1], "sapUiSizeCompact", "sapUiSizeCompact is the default Class added to document.body");
		...
		assert.equal(Utility.findSapUiSizeClass(), "sapUiSizeCompact", "The method findSapUiSizeClass should return sapUiSizeCompact");
		document.querySelector('.sapUiBody').classList.remove("sapUiSizeCompact");

		document.querySelector('.sapUiBody').classList.add("sapUiSizeCozy");
		assert.equal(Utility.findSapUiSizeClass(), "sapUiSizeCozy", "The method findSapUiSizeClass should return sapUiSizeCozy");
		document.querySelector('.sapUiBody').classList.remove("sapUiSizeCompact");

		document.querySelector(".sapUiBody").classList.add("sapUiSizeCondensed");
		assert.equal(Utility.findSapUiSizeClass(), "sapUiSizeCondensed", "The method findSapUiSizeClass should return sapUiSizeCondensed");
		document.querySelector('.sapUiBody').classList.remove("sapUiSizeCompact");
	});
});
