...
sap.ui.define([
	...
	QUnit.test("SlashPattern for HCB Theme with semantic color", function (assert) {
		var done = assert.async();
		this.applyTheme("sap_belize_hcb", function() {
			...
			assert.ok(this.slashPatternGrey1.getStroke().includes("#fff"), "SlashPattern grey  getStroke succeeds");
			...
			assert.ok(this.slashPatternGrey2.getStroke().includes("#fff"), "SlashPattern grey  getStroke succeeds");
			...
			assert.ok(this.slashPatternGrey3.getStroke().includes("#fff"), "SlashPattern grey  getStroke succeeds");
			...
			assert.ok(this.slashPatternGrey4.getStroke().includes("#fff"), "SlashPattern grey  getStroke succeeds");
			...
			assert.ok(this.slashPatternGrey5.getStroke().includes("#fff"), "SlashPattern grey  getStroke succeeds");
