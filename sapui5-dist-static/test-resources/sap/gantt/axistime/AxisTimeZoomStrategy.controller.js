sap.ui.define([
	...
	var Controller = Controller.extend("test.sap.gantt.axistime.AxisTimeZoomStrategy", {
		onInit: function(){
			...
			var oStrategyDemoData = new JSONModel(sap.ui.require.toUrl("test/sap/gantt/axistime" + sDataFilePath));
			...
			this._oTypeHelpPopover = sap.ui.xmlfragment({
				fragmentContent: jQuery(document.getElementById("fragment1")).html()
			});
			this._oControlTypeHelpPopover = sap.ui.xmlfragment({
				fragmentContent: jQuery(document.getElementById("fragment2")).html()
			});
