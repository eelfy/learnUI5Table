	...
	Calendar, TimeInterval, CalendarDefs, ProportionZoomStrategy, PerfSetting, Controller) {
		...
		return Controller.extend("sap.gantt2.perf.controller.App", {
			...
			setInfoLabels: function (bScenarioChanged) {
				...
				oColumnsInfoLabel.setText("Columns " + (bScenarioChanged ? this.ALL_SCENARIOS[this.scenatioId].numberOfColumns : parseInt(this.getView().byId("customizedColumns").getValue(), 10)) + ",");
				...
				oCustomizedColumnsInput.setValue(bScenarioChanged ? this.ALL_SCENARIOS[this.scenatioId].numberOfShape : parseInt(this.getView().byId("customizedColumns").getValue(), 10));
			...
			createModel: function () {
				...
				mSettings.numberOfColumns = parseInt(this.getView().byId("customizedColumns").getValue(), 10) || mSettings.numberOfColumns;
				this.setInfoLabels();
