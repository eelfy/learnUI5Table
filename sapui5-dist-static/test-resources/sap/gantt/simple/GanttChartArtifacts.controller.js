sap.ui.define([
	...
	"sap/base/util/UriParameters"
            ...
            DateFormat, FullScreenStrategy, UriParameters) {
	"use strict";
	...
	return Controller.extend("sap.gantt.simple.test.GanttChartArtifacts", {
		...
		onInit : function() {
			...
			var bProportion = oUriParameters.get("proportion");
		...
		shapeSettingsSelected: function (oEvent) {
			...
			if (oItem.getText() === "MultipleWithLasso" || oItem.getText() === "MultiWithKeyboardAndLasso") {
		...
		if (this.getView().byId("invertLasso").getSelected()) {
			this.oGantt.setEnableLassoInvert(true);
		} else {
			this.oGantt.setEnableLassoInvert(false);
		}
		},
