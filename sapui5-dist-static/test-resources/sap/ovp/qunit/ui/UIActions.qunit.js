    ...
    "sap/ovp/cards/jUtils"
],function (utils, mockservers, CommonUtils, UIActions, jUtils) {
            "use strict";
            ...
            asyncTest("check double tap", function () {
                ...
                var touchstartEvent = Object.assign(new UIEvent('touchstart'),
                        {touches:[{pageX: 10, pageY:10, target: draggableDOMRef}]});
                var touchendEvent = Object.assign(new UIEvent('touchend'),
            ...
            asyncTest("check switch to drag mode and clone creation", function () {
                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ...
                        QUnit.assert.ok(document.querySelector('#root').querySelectorAll('.clone').length === 1, "make sure a clone was created");
                        start();
