sap.ui.define([
    ...
    "/sap/ovp/ui/CustomData"
            ...
            test("Test Object Stream - optimized updateContent", function(){
                ...
                equal(factorySpy.callCount, 6, "factory call count");
                equal(setBiningContextSpy.callCount, 6, "setBinding call count");
            ...
            test("Test Object Stream - Screen Reader attribute test", function(){
                ...
                this.oObjectStream.onAfterRendering = function () {
                    ...
                    var objectStreamHeaderHtml = objectStreamHtml.childNodes[0];
                    var objectStreamCloseHtml = objectStreamHtml.querySelector(".sapOvpObjectStreamClose");
                    var objectStreamScrollHtml = objectStreamHtml.querySelector(".sapOvpObjectStreamScroll");
                    ...
                    ok(objectStreamCloseHtml.getAttribute("role") == "button", "object Stream close role is define");
                    ok(objectStreamCloseHtml.getAttribute("aria-label") == "close", "object Stream close aria-label is define");
                    ok(objectStreamScrollHtml.getAttribute("role") == "list", "object Stream content role is define");
