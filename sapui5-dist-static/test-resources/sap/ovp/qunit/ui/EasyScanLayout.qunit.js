sap.ui.define([
...
],function (utils, mockservers, jQuery, CommonUtils, EasyScanLayout, CustomData, Keycodes, jUtils) {
    "use strict";
    ...
    test("EasyScan Layout - Ctrl-Arrow D&D Handle", function () {
        ...
        easyScan.onAfterRendering = function () {
            ...
            ok(setTimeout(function() { (jUtils.getIndex(document.activeElement)) ==  1}, 500), "Focus stay on second item");
            ...
            ok(setTimeout(function() {(jUtils.getIndex(document.activeElement)) == 0}, 500), "Focus move to first item");
            ...
            ok(setTimeout(function() {(jUtils.getIndex(document.activeElement)) == 0}, 500), "Focus is on first item");
    ...
    test("EasyScan Layout - F6,F7 Handle", function () {
        ...
        easyScan.onAfterRendering = function () {
            ...
            keyboardNavigation.keydownHandler(event);
            ok(document.activeElement.classList.contains("after"), "after element received focus");
            keyboardNavigation._ignoreSelfFocus = true;
            keyboardNavigation.afterFocusHandler();
            ok(document.activeElement.classList.contains("after"), "focus stayed on after element");
            keyboardNavigation.afterFocusHandler();
            ok(!document.activeElement.classList.contains("after"), "focus moved from after element");
