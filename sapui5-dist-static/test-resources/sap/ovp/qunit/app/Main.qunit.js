sap.ui.define([
...
], function (utils, jquery, isEmptyObject) {
    "use strict";
    ...
    test("Read with no filters", function () {
        ...
        ok(eventbusStub.callCount === 0, "Event shhould not be fired if there is no change");
        ...
        ok(eventbusStub.calledOnce === true, "Event shhould  be fired if there is  change");
    });
    ...
    test("Get Current AppState with no filters", function () {
        ...
        ok(isEmptyObject(val.customData._CUSTOM), "Custom Filters must be empty");
        ok(isEmptyObject(val.customData._EXTENSION), "Extension Filters must be empty");
    ...
    test("Card template Class is typeof sap.ovp.cards.generic.Component", function () {
        // jQuery.sap.declare("sap.ovp.test.card.Component");
        sap.ui.require("sap.ovp.cards.generic.Component");
    ...
    test("Init Global Filter - apply automatically is selected", function () {
        var globalFilter = _mockGlobalFilter();
        oController._initGlobalFilter();
        oController.oNavigationHandler = {
            parseNavigation: function () {
        ...
        ok(oController.bGlobalFilterLoaded === true, "oGlobalFilterLoadedPromise will get resolved and cards will be active");
    });
    
    test("Init Global Filter - apply automatically is not selected", function () {
        var globalFilter = _mockGlobalFilter();
        oController._initGlobalFilter();
        oController.oNavigationHandler = {
            parseNavigation: function () {
        ...
        ok(oController.bGlobalFilterLoaded === undefined, "oGlobalFilterLoadedPromise will not get resolved and cards will be inactive");
    });
    ...
    test("Action Button - Save As Tile", function () {
        ...
        document.body.insertAdjacentHTML('beforeend', '<div id="testContainer" style="height:600px; width:1500px">');
    ...
    //                sap.ui.require("sap.ui.comp.smartvariants.PersonalizableInfo");
    ...
    //                };
    //
    //                sap.ui.require("sap.ui.core.util.MockServer");
    ...
    test("validate _mergeDefaultWithSFBVariant", function () {
        var oDefaultParamsVariant = new sap.ui.generic.app.navigation.service.SelectionVariant();
        var oSFBSelectionVariant = new sap.ui.generic.app.navigation.service.SelectionVariant();
        ...
        ok(mergedVariant.getSelectOption("a")[0].Low === "1");
        ok(mergedVariant.getSelectOption("b")[0].Low === "2");
        ok(mergedVariant.getSelectOption("c")[0].Low === "4");
    });
    ...
    test("Test setTitle function", function () {
        var subtitle = "subtitle";
        var description = "description";
        var title = "apptitle";
        ok(oController.setTitle(subtitle, description, title) === subtitle, "Subtitle takes precedence");

        subtitle = null;
        description = "description";
        title = "apptitle";
        ok(oController.setTitle(subtitle, description, title) === description, "Description takes precedence");

        subtitle = undefined;
        description = null;
        title = "apptitle";
        ok(oController.setTitle(subtitle, description, title) === title, "Title takes precedence");

        subtitle = "subtitle";
        description = null;
        title = "apptitle";
        ok(oController.setTitle(subtitle, description, title) !== description, "Description will not take precedence");
    });
});
