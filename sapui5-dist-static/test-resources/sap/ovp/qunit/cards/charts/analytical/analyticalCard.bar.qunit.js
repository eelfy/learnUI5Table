sap.ui.define([
    ...
    "test-resources/sap/ovp/mockservers"
], function (cardUtils, oChartUtils, mockservers) {
            "use strict";
            ...
            module("sap.ovp.cards.charts.Bar", {
                /**
            ...
            test("Bar chart - Without Filters",function(){
                ...
                oModel.getMetaModel().loaded().then(function () {
                    ...
                    oView.loaded().then(function (oView) {
                        ...
                        sap.ovp.cards.charts.VizAnnotationManager.buildVizAttributes(cardViz, null, null, oController);
                        ...
                        ok(chartUtils.vizNodeExists(cardXml, expectedListRes.VizFrame.vizType), "VIZ Frame - see that there is a VIZFrame for bar chart");
            ...
            test("Bar chart - With Filters",function(){
            ...
            test("Bar chart - With Filters Without Sorters",function(){
            ...
            test("Bar chart - With faulty filter configuration",function(){
                var cardTestData = {
                    card: {
                        "id": "chart_5",
                        "model": "salesShare",
            ...
            test("Bar chart - Without DataPoint Annotation",function(){
            ...
            test("Bar chart - With DataPoint, Without Title and Value",function(){
            ...
            test("Bar chart - With ObjectStream Filters",function(){
                var cardTestData = {
                    card: {
                        "id": "chart_8",
                        "model": "salesShare",
            ...
            test("Bar chart - With MeasureAttributes and DimensionAttributes missing",function(){
                var cardTestData = {
                    card: {
                        "id": "chart_9",
                        "model": "salesShare",
                ...
                oModel.getMetaModel().loaded().then(function () {
                    ...
                    oView.loaded().then(function (oView) {
                        ...
                        // basic list XML structure tests
                        ok(chartUtils.ovpNodeExists(cardXml), "OVP Card - see that there is a OVP Card Format");
                        ok(chartUtils.vizNodeNotExists(cardXml, expectedListRes.VizFrame.vizType), "VIZ Frame - see that there is no VIZFrame rendered for Bar chart");
                    });
                });
            });
