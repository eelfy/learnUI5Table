...
sap.ui.define(["/sap/ovp/cards/MetadataAnalyser"
	...
	module("Test to check for analytical parameterised entity set", {
		setup: fnGeneralSetup,
		teardown: fnGeneralTeardown
	});
	...
	QUnit.test("Test for analytical parameterised test", function(assert){
		var oComponent = oController.getOwnerComponent();
		var oAppComponent = oComponent.getAppComponent();
		var aProperty  = MetadataAnalyser.checkAnalyticalParameterisedEntitySet(oAppComponent.getModel(), "NavigationEntity1");
