                ...
                oModel.getMetaModel().loaded().then(function () {
                    ...
                    oView.loaded().then(function (oView) {
                        ...
                        oView.onAfterRendering = function () {
                            ...
                            //Check list
                            ok((numberLabelObject.getAttribute("aria-label") == sap.ui.getCore().getLibraryResourceBundle("sap.ovp").getText("stackCard", stackCardSize)), "Stack Card type is accessble");
                            ok(numberLabelObject.getAttribute("role") == "", "card role is define");

                            //Check footer
                            var StackCardContent = testContainer.querySelector(".sapOvpStackCardContent");
                            ok(StackCardContent.getAttribute("aria-label") == sap.ui.getCore().getLibraryResourceBundle("sap.ovp").getText("stackCardContent", [stackCardSize, totalCards]), "aria-label is define on right content");
                            ok(StackCardContent.getAttribute("role") == "button", "button role is define on right content");
                            oView.destroy();
                        };
                    });
                });
