sap.ui.define([
    ...
    "/sap/ovp/cards/AnnotationHelper"
            ...
            test("Annotation Helper - formatDataPoint with valueFormat annotation", function () {
                ...
                ok(result.indexOf(sExpectedResult) > -1);
            });
            ...
            test("Annotation Helper - formatDataPoint with valueFormat annotation and 'scale' attribute in the metadata", function () {
                ...
                var result = AnnotationHelper.formatDataPointValueOnIndex (ctx, aCollection, 0);
                ok(result.indexOf(sExpectedResult) > -1, "The number format function takes the numberOfFractionalDigits as the static value");
            });
            ...
            test("Annotation Helper - formatDataPoint with no valueFormat annotation and with 'scale' attribute in the metadata will have default value as Zero", function () {
                ...
                var result = AnnotationHelper.formatDataPointValueOnIndex (ctx, aCollection, 0);
                ok(result.indexOf(sExpectedResult) > -1, "he number format function takes the numberOfFractionalDigits as the static value");
            });
            ...
            module("Support for Semantic Date", {
                beforeEach: function () {
                    this.oDateSettings = {
                        "DeliveryDate" : {
                        ...
                        "SubmittedDate" : {
                            "filter": [
                                {"path": "key", "contains": "TOMORROW", "exclude": false}
                            ]
                        },
                        "CreatedDate": {
            ...
            test("Annotation Helper - isDateRangeType", function () {
                 var oExpectedResult = {
                    "SupplierName": false,
                    "Land1": false,
                    "MaterialName": false,
                ...
                for (var i = 0; i < this.allControlConfiguration.length; i++) {
                    bResult = AnnotationHelper.isDateRangeType(this.allControlConfiguration[i].PropertyPath, this.oDateSettings);
                    ok(bResult === oExpectedResult[this.allControlConfiguration[i].PropertyPath]);
                }
            });
            test("Annotation Helper - getConditionTypeForDateProperties", function () {
                var oExpectedResult = {
                ...
                for (var i = 0; i < this.allDateControlConfiguration.length; i++) {
                    bResult = AnnotationHelper.getConditionTypeForDateProperties(this.allDateControlConfiguration[i].PropertyPath, this.oDateSettings);
                    ok(bResult === oExpectedResult[this.allDateControlConfiguration[i].PropertyPath]);
                }
            });
            test("Annotation Helper - getGroupID", function () {
                var oExpectedResult = {
                    "SupplierName": "_BASIC",
                    "Land1": "_BASIC",
                    "MaterialName": "_BASIC",
