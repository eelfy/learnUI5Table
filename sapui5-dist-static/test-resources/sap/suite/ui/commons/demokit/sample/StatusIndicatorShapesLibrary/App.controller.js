sap.ui.define(
	...
	function (jQuery, JSONModel, Controller, Fragment, MessageToast, LibraryShape) {
		...
		return Controller.extend("sap.suite.ui.commons.sample.StatusIndicatorShapesLibrary.App", {
			onInit: function () {
				var oModel = new JSONModel(sap.ui.require.toUrl("sap/suite/ui/commons/sample/StatusIndicatorShapesLibrary/Data.json")),
			...
			onPressStatusIndicator: function (oEvent) {
				...
				if (!this._oPopover) {
					sap.ui.core.Fragment.load({
						...
						name: "sap.suite.ui.commons.sample.StatusIndicatorShapesLibrary.Popover",
						type: "XML"
