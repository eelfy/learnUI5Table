sap.ui.define(
	...
	function (JSONModel, Controller, LayeredLayout, ForceBasedLayout, ActionButton, Node) {
		...
		GraphController.prototype.onInit = function () {
			this._oModel = new JSONModel(sap.ui.require.toUrl("sap/suite/ui/commons/sample/NetworkGraphOrgChart/graph.json"));
		...
		GraphController.prototype._openDetail = function (oNode, oButton) {
			...
			if (!this._oQuickView) {
				sap.ui.core.Fragment.load({
					name: "sap.suite.ui.commons.sample.NetworkGraphOrgChart.TooltipFragment",
					type: "XML"
