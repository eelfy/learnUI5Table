sap.ui.define([
	...
	QUnit.test("The active property of 'toolbar' aggregation is true, only if Chart Container's title is present", function(assert) {
		// Arrrange
		// Act
		// Assert
		assert.equal(this.oChartContainer._oToolBar.getActive(), true, "The active property of 'toolbar' aggregation is false, if title is not present");
		...
		assert.equal(this.oChartContainer._oToolBar.getActive(), false, "The active property of 'toolbar' aggregation is true, if title is present");
	});
