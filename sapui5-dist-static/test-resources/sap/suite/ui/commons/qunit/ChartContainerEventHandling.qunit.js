sap.ui.define([
	...
	QUnit.test("FullScreen toggle button", function(assert) {
		// Arrange
		var sTooltipText = this.oChartContainer._oFullScreenButton.getTooltip();
		var sToggleButtonText = this.oChartContainer._oFullScreenButton.getText();

		// Assert
		assert.equal(sTooltipText,sToggleButtonText, "Tooltip & text for full screen toggle button are same");
	});
