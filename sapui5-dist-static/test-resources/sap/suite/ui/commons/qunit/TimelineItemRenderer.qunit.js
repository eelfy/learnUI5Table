sap.ui.define([
	...
	QUnit.test("Test tab button event", function (assert) {
		var aData = [
			{
				dateTime: new Date(2016, 0, 1),
				title: "Item 1"
		...
		assert.equal(document.activeElement, oTimeline.$().find(".sapSuiteUiCommonsTimelineItemOutline").get(0), "Focus comes on the timeline item");
	});
});
