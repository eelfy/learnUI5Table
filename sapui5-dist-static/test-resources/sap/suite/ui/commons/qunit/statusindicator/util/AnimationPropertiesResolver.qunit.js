sap.ui.define([
	...
	QUnit.test("color specified by threshold", function (assert) {
		...
		assert.equal(oResolver.getColor(oRectangle1, 76), "black");
		assert.equal(oResolver.getColor(oRectangle2, 76), "black");
		assert.equal(oResolver.getColor(oRectangle3, 76), "black");
		oStatusIndicator.setValue(100);
		assert.equal(oResolver.getColor(oRectangle1, 100), "black");
		assert.equal(oResolver.getColor(oRectangle2, 100), "black");
