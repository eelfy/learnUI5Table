sap.ui.define("STTA_MP.ext.controller.ListReportExtension", [
	...
	return {
		...
		getCustomAppStateDataExtension: function(oCustomData) {
			...
			// Example:
			var oComboBox = this.byId("CustomFilter-Price-combobox");
			if (oComboBox) {
				oCustomData.CustomPriceFilter = oComboBox.getSelectedKey();
			}
			var oTShirtSizeComboBox = this.byId("CustomFilter-Weight-combobox");
	...
	//		debugger;
			if (oCustomData.CustomPriceFilter !== undefined) {
				if (this.byId("CustomFilter-Price-combobox")) {
					this.byId("CustomFilter-Price-combobox").setSelectedKey(oCustomData.CustomPriceFilter);
				}
			}
			if (oCustomData.sTShirtSizeFilter !== undefined) {
				if (this.byId("CustomFilter-Weight-combobox")) {
					this.byId("CustomFilter-Weight-combobox").setSelectedKey(oCustomData.sTShirtSizeFilter);
				}
			}
		},	
