sap.ui.define(["sap/suite/ui/generic/template/genericUtilities/AjaxHelper", "sap/base/util/UriParameters"], function (AjaxHelper, UriParameters) {
	"use strict";
	...
	Utils.getAppInfo = function (sDemoApp, sCalledFromOpt) {
		...
		switch (sDemoApp) {
			case "demoObjectPageSections":
				sModulePath = "./demoObjectPageSections/webapp";
				break;
			case "demoObjectPageExtensions":
				sModulePath = "./demoObjectPageExtensions/webapp";
				break;
		...
		return {
			moduleName: sModuleName || sDemoApp,
	...
	* */
	...
	/**
	 * Create a new random number and return as number
	...
	Utils.getGUID = function () {
		var _get4Char = function () {
			return Math.floor((1 + Utils.getRandomNumber()) * 0x10000)
				.toString(16)
				.substring(1);
		};
