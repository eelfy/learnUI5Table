...
sap.ui.define([ "testUtils/sinonEnhanced", "sap/ui/model/json/JSONModel",
	...
	oPrivateModel.deleteCreatedEntry = function(){};
	var oModelObject = {};
...
var oTemplateUtilsDraft = {
    ...
    var CreateWithDialogHandler = new CreateWithDialogHandlerInstance(oState, oController, oTemplateUtils);
    var CreateWithDialogHandlerDraft = new CreateWithDialogHandlerInstance(oState, oController, oTemplateUtilsDraft);
	
	var oStubForPrivate;

	module("CreateWithDialogHandler", {
		setup : function() {
