...
sap.ui.define([
	...
	QUnit.test("Check getSideContentExtensionPoint function", function() {
		var sFacetId = "to_ProductSalesData::com.sap.vocabularies.UI.v1.Chart"; 
		...
		var result = AnnotationHelperSideContent.getSideContentExtensionPoint(sEntitySet, sFacetId, oManifestExtend);
		assert.equal(result, sExtensionPoint, "Extension point fetched correctly" );
		
		sFacetId = "to_ProductSalesData::@com.sap.vocabularies.UI.v1.LineItem"; 
		
		sExtensionPoint = false;
		result = AnnotationHelperSideContent.getSideContentExtensionPoint(sEntitySet, sFacetId, oManifestExtend);
		assert.equal(result, sExtensionPoint, "Extension point fetched correctly" );
