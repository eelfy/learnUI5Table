...
sap.ui.define(["testUtils/sinonEnhanced", "sap/ui/model/json/JSONModel", "sap/suite/ui/generic/template/lib/BusyHelper", "sap/suite/ui/generic/template/lib/MessageUtils"
], function(sinon, JSONModel, BusyHelper, MessageUtils) {
	"use strict";
	...
	var oTemplateContract = {
		...
		oViewDependencyHelper: Function.prototype,
		oNavigationObserver: {},
		oApplicationProxy: {},
		oTemplatePrivateGlobalModel: new JSONModel({
			generic: {
				placeholdersShown: Object.create(null)
			}
		})
	};
	var oBusyHelper;
