...
sap.ui.define(
	[ "sap/suite/ui/generic/template/AnalyticalListPage/control/visualfilterbar/FilterItemMicroChart" ], function(FilterItemMicroChart) {
		...
		*/
		...
		oFilterItemMicroChart.getLazyLoadVisualFilter = function() {
			return true;
		}
		...
		*/
		...
		QUnit.test('lazyLoadVisualFilter test', function() {
			assert.equal(oFilterItemMicroChart.getLazyLoadVisualFilter(), true);
		});
	}
);
