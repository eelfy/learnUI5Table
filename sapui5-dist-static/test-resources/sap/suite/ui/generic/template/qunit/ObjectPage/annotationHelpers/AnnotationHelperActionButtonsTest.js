...
sap.ui.define([
	...
	QUnit.test("Function getDeleteActionButtonVisibility returns '{= !${ui>/editable} }' WHEN the restriction annotations are undefined (not maintained) for a Draft Application", function() {
	    ...
	    equals(AnnotationHelperActionButtons.getDeleteActionButtonVisibility(this.oInterface, this.mRestrictions, this.oEntitySet, {}, oTreeNode), expected, "Returned expression is correct");
	});
	...
	QUnit.test("Function getDeleteActionButtonVisibility returns a complex binding WHEN the restriction annotations has a valid Path for a Non Draft FCL Application with 3rd Column Open", function() {
	    ...
	    equals(AnnotationHelperActionButtons.getDeleteActionButtonVisibility(this.oInterface, this.mRestrictions, this.oEntitySet, oAppComponent, oTreeNode), expected, "Returned expression is correct");
	});
	...
	QUnit.test("check method getDatafieldForActionVisibility with Mock data in draft case", function () {
	...
	QUnit.test("check method getDatafieldForActionVisibility in simple scenario in non-draft case", function () {
