	...
	function (opaTest) {
		...
		opaTest("Switching to _tab2", function (Given, When, Then) {
			...
			Then.onTheListReportPage
				...
				.and
				.iCheckCustomDataOfControl("sap.ui.comp.smartchart.SmartChart", "listReport-_tab2", {"presentationVariantQualifier": "Chart1", "chartQualifier": "Chart1", "variantAnnotationPath": "com.sap.vocabularies.UI.v1.SelectionPresentationVariant#Chart1", "text": "Chart1"});
		});
