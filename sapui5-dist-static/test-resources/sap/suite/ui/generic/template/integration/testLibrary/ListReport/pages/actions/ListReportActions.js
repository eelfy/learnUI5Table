					...
					return this.waitFor({
						...
						success: function(oDynamicPage) {
							...
							this.waitFor({
								...
								success: function () {
									Opa5.assert.ok(true, "The smartfilterbar search trigerred successfully");
								},
				...
				*/
				...
				iClickOnIconTabFilter: function(sKey) {
					...
					return this.waitFor({
						...
						success: function () {
							Opa5.assert.ok("Icon tab bar with key '" + sKey + "' is clicked");
						},
				...
				iClickOnSegmentedButton: function(sKey) {
					...
					return this.waitFor({
						...
						success: function () {
							Opa5.assert.ok("Segmented button with the key '" + sKey + "' is clicked");
						},
...
*/
				...
				*/
				...
				/**
				 * Click on an item from the Shell Navigation Menu
				 *
