...
sap.ui.define(["sap/ui/test/opaQunit"], function() {
	...
	opaTest("Check if the table is Analytical Table and navigation higlight works",function(Given,When,Then){
		// Assertions
        ...
        Then.onTheMainPage.iShouldSeeTheNavigatedRowHighlightedAnalytical(2, true);
        Then.onTheMainPage.iShouldSeeTheNavigatedRowHighlightedAnalytical(4, false);
