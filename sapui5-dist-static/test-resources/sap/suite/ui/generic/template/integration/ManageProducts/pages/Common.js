sap.ui.define(['sap/ui/test/Opa5'], function(Opa5) {
	...
	var Common = Opa5.extend("sap.suite.ui.generic.template.integration.ManageProducts.pages.Common", {
		...
		iStartMyAppWithChange : function() {
			...
			return this.iStartMyAppInAFrame("test-resources/sap/suite/ui/generic/template/demokit/demokit.html?serverDelay=0&responderOn=true&sap-ui-xx-componentPreload=off&demoApp=sttaproducts&sap-ui-language=en_US");
		}
	});
