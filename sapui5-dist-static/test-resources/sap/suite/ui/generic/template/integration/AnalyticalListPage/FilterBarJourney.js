...
sap.ui.define([
	...
	opaTest("Check filterable KPI gets hidden in Go mode", function(Given, When, Then) {
		...
		Then.onTheMainPage.thePageVariantShouldBeMarkedDirty(false);
		When.onTheMainPage.iCheckForHiddenKPI("ActualMarginRelative5");
		When.onTheMainPage.iCheckForHiddenKPI("ActualMarginRelative4");
		When.onTheMainPage.iCheckForHiddenKPI("ActualMarginRelative3");
		When.onTheMainPage.iCheckForHiddenKPI("TargetMargin2");
		When.onTheMainPage.iCheckForHiddenKPI("ActualMarginRelative2");
		When.onTheMainPage.iCheckForHiddenKPI("TargetMargin");
		When.onTheMainPage.iCheckForHiddenKPI("ActualMarginRelative");
		...
		Then.onTheMainPage.thePageVariantShouldBeMarkedDirty(true);
		...
		When.onTheMainPage.iClickTheKPI("TargetMargin2");
	...
	opaTest("KPICards dataLabel visibility", function(Given, When, Then) {
		...
		Then.onTheMainPage.iCheckChartDataLabel(true);
		When.onTheMainPage.iClickTheKPI("ActualMarginRelative");
		Then.onTheMainPage.iCheckChartDataLabel(true);
		Given.iTeardownMyApp();
	});
	...
	// Test to check pin button. It should not be present
	...
	*/
	...
	opaTest("VF Tooltip", function(Given, When, Then) {
		Then.onTheFilterBar.checkVFTitle("ActualCosts", "CostCenter", "tooltip", "quick info for Actual costs by quick info for cost center in USD");
		Then.onTheFilterBar.checkVFTitle("ActualCosts", "CostElement", "tooltip", "quick info for Actual costs by Cost Element in USD");
	});
