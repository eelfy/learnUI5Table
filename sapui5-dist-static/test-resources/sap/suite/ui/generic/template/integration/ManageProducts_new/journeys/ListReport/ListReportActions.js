	...
	function (opaTest) {
		...
		opaTest("#3 Check button enablement for requiresSelection - disabled buttons", function (Given, When, Then) {
			When.onTheListReportPage
				.iClickTheControlWithId("STTA_MP::sap.suite.ui.generic.template.ListReport.view.ListReport::STTA_C_MP_Product--listReport-persoController-P13nDialog-cancel", "Cancel");
