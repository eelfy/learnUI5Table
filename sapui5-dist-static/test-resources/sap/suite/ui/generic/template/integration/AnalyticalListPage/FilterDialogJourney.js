...
sap.ui.define([
	...
	*/
	opaTest("Switch filter mode to Visual Filter", function(Given, When, Then) {
	 ...
	 opaTest("Check for aria-haspopup", function(Given, When, Then) {
		...
		When.onTheVisualFilterDialog.iClickDialogButton('Cancel', "SmartFilterBar-adapt-filters-dialog-cancelBtn", "analytics2");
		...
		Then.onTheFilterBar.iCheckForButtonWithAriaHasPopup("template::Share", false);
	 });
	/*
	OPA for value help
	*/
	opaTest("Check Support of Value help button", function(Given, When, Then) {
		...
		Then.onTheVisualFilterDialog.iCheckSelectedButtonCount(3, "Cost Center");
	});
	opaTest("Check tooltip for value help button on the VFD- VH with selections", function(Given, When, Then) {
		Then.onTheVisualFilterDialog.iCheckVHTooltip("Bar", "Cost Center", "VH_MULTI_SELECTED", 3);
	});
	...
	*/
	/*opaTest("Check chart and its title", function(Given, When, Then) {
		...
		//When.onTheVisualFilterDialog.iClickTheSegmentedButton("group");
		//When.onTheVisualFilterDialog.iAddFilterValueInCompactDialog("Cost Element", "400020");
		When.onTheVisualFilterDialog.iClickTheSegmentedButton("visual");
