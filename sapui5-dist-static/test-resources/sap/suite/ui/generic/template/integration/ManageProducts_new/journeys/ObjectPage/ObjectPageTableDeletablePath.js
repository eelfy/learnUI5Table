	...
	function(opaTest) {
		...
		opaTest("Check the Show Details button on the Table and None, Low and Medium importance columns are hidden from the table popin", function (Given, When, Then) {
			When.onTheObjectPage
				.iLookAtTheScreen();
			Then.onTheObjectPage
				.iCheckTableToolbarControlProperty({ "btnShowHideDetails": [true, true, "Show Details"] }, "to_ProductText::com.sap.vocabularies.UI.v1.LineItem::responsiveTable")
				.and
		...
		opaTest("Click on the Show Details button and check None, Low and Medium importance columns are displayed as table popin", function (Given, When, Then) {
			...
			Then.onTheObjectPage
				.iCheckTableToolbarControlProperty({ "btnShowHideDetails": [true, true, "Hide Details"] }, "to_ProductText::com.sap.vocabularies.UI.v1.LineItem::responsiveTable")
				.and
