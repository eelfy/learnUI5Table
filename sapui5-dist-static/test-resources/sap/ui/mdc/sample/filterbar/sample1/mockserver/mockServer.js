sap.ui.define([
	...
	return ManagedObject.extend("sap.ui.mdc.sample.filterbar.sample1.mockserver.mockServer", {

		started: null,
		init: function () {
			var mockData, metadata;

			this.started = jQuery.get("./../sample1/mockserver/ProductList.json").then(function (data, status, jqXHR) {
				mockData = data;
				return jQuery.get("./../sample1/mockserver/metadata.xml");
