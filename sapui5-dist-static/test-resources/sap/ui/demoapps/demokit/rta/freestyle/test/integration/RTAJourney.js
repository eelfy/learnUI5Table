...
sap.ui.define(
	function() {
		...
		opaTest("Exiting RTA", function(Give, When, Then) {
			...
			Then.onTheMasterPageWithRTA.iShouldSeeTheFLPToolbarAndChangesInLRep(4, "sap.ui.demoapps.rta.freestyle.Component");
		});
		...
		opaTest("Reloading the App", function(Given, When, Then) {
			...
			Then.onTheMasterPageWithRTA.iShouldSeeChangesInLRepWhenTheBusyIndicatorIsGone("idAppControl", "Root", 4, "sap.ui.demoapps.rta.freestyle.Component").
