...
//			var sId = "sap.ui.demoapps.rta.fiorielements::sap.suite.ui.generic.template.ObjectPage.view.Details::SEPMRA_C_PD_Product--com.sap.vocabularies.UI.v1.FieldGroup::TechnicalData::FormGroup";
////			var sNewTitle = "Renamed New Group";
////			When.onTheMasterPageWithRTA.iRightClickOnAnElementOverlay(sId).
////			and.iClickOnAContextMenuEntry(2).and.iEnterANewName(sNewTitle).
////			and.iClickOnAnElementOverlay(sId);
//			var sNewTitle = "New: Group";
//			When.onTheMasterPageWithRTA.iRightClickOnAnElementOverlay(sId).
//			and.iClickOnAContextMenuEntry(2).
//			and.iClickOnAnElementOverlay(sId);
//
//			Then.onTheMasterPageWithRTA.iShouldSeeTheGroupByTitle(sNewTitle);
//		});

		opaTest("Exiting RTA", function(Give, When, Then) {
			When.onTheMasterPageWithRTA.iExitRtaMode();

			Then.onTheMasterPageWithRTA.iShouldSeeTheFLPToolbarAndChangesInLRep(3, "sap.ui.demoapps.rta.fiorielements.Component");
		});
		...
		opaTest("Reloading the App", function(Given, When, Then) {
			...
			Then.onTheMasterPageWithRTA.iShouldSeeChangesInLRepWhenTheBusyIndicatorIsGone("mainShell", undefined, 3, "sap.ui.demoapps.rta.fiorielements.Component").
