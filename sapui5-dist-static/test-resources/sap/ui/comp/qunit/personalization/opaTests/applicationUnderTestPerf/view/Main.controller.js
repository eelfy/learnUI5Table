sap.ui.define([
	...
	return Controller.extend("view.Main", {
		...
		_initVariantManagement: function() {
			...
			oControl.getVariantManagement = function() {
				return this.getView().byId("IDSmartVariantManagement");
			}.bind(this);
			...
			var fGetProperty = oControl.getProperty.bind(oControl);
			oControl.getProperty = function(s) {
				if (s === "persistencyKey") {
					return "PKeyApplicationUnderTestPerf";
				}

				return fGetProperty(s);
			};
			oControl.getPersistencyKey = function(){
				return this.getProperty("persistencyKey");
			};
