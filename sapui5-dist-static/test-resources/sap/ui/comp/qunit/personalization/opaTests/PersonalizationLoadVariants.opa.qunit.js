...
sap.ui.require([
	...
	opaTest("When I load 'Compatibility02' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility02");
	...
	opaTest("When I load 'Compatibility03' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility03").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "COLUMSPANEL_TITLE"));
	...
	opaTest("When I load 'Compatibility04' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility04").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "COLUMSPANEL_TITLE"));
	...
	opaTest("When I load 'Compatibility05' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility05").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "COLUMSPANEL_TITLE"));
	...
	opaTest("When I load 'Compatibility06' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility06").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "COLUMSPANEL_TITLE"));
	...
	opaTest("When I load 'Compatibility07' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility07").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "COLUMSPANEL_TITLE"));
	...
	opaTest("When I load 'Compatibility09' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility09").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "COLUMSPANEL_TITLE"));
	...
	opaTest("When I load 'Compatibility10' variant and open columns panel of the dialog, some columns should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility10").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "COLUMSPANEL_TITLE"));
