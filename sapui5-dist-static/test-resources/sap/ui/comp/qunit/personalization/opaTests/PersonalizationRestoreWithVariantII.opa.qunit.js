...
sap.ui.require([
	...
	opaTest("When I load 'PriceAtFirstAndDateAtLast' variant and open the dialog, the variant columns should appear and the 'Restore' button should be disabled", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("PriceAtFirstAndDateAtLast").and.iPressOnPersonalizationButton(true).and.iNavigateToPanel(Util.getTextFromResourceBundle("sap.m", "COLUMSPANEL_TITLE"));
