...
"use strict";
	...
	//BCP: 2070256920
	QUnit.test("getUOMDisplayFormatter for non-currency type with scale type with scale", function(assert) {
		...
		// assert
		assert.strictEqual(sFormattedValue1, "1.0 ");
	});

	QUnit.test("getUOMDisplayFormatter for non-currency type without scale", function(assert) {
		...
		// assert
		assert.strictEqual(sFormattedValue1, "1.000 ");
	});

	QUnit.test("getUOMDisplayFormatter for currency type with scale", function(assert) {
		...
		var sMeasure = "1",
			...
			sFormattedValue1 = fnFormatter(sMeasure, sUnit);
		// assert
		assert.strictEqual(sFormattedValue1, "1.00 ");
	});
