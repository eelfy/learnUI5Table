sap.ui.define([
    ...
    var ID_PREFIX = "__xmlview0--",
		...
		VALUE_LIST_NOVALIDATION_VALUE_HELP_BUTTON = ID_PREFIX + "idValueListNoValidation-input-vhi";
    ...
    return {
		...
		iPressTheValueListNoValidationValueHelpButton: function () {
            return this.waitFor(__createWaitForPressValueHelpButton(
                VALUE_LIST_NOVALIDATION_VALUE_HELP_BUTTON,
                VALUE_LIST_NAME));
        },
        ...
        iEnterAManufacturerInTheValueListNoValidationField: function (sValue) {
            return this.waitFor(__createWaitForEnterValueInField(
