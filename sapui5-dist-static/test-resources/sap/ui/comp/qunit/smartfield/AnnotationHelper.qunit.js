...
sap.ui.define([
	...
	QUnit.test("getImportanceAnnotation", function(assert) {
		// Arrange
		var sHigh = "High",
			sMedium = "Medium",
			sLow = "Low",
			...
			oProperty = {
				"com.sap.vocabularies.UI.v1.Importance": {
					"EnumMember": "com.sap.vocabularies.UI.v1.ImportanceType/" + sHigh
				}
			};

		// Act
		sResult = this.oMetaData.getImportanceAnnotation(oProperty);

		// Assert
		assert.equal(sResult, sHigh, "High importance is correctly returned");

		// Arrange
		oProperty = {
			"com.sap.vocabularies.UI.v1.Importance": {
				"EnumMember": "com.sap.vocabularies.UI.v1.ImportanceType/" + sMedium
			}
		};
		...
		// Assert
		assert.equal(sResult, sMedium, "Medium importance is correctly returned");

		// Arrange
		oProperty = {
			"com.sap.vocabularies.UI.v1.Importance": {
				"EnumMember": "com.sap.vocabularies.UI.v1.ImportanceType/" + sLow
			}
		};
		...
		// Assert
		assert.equal(sResult, sLow, "Low importance is correctly returned");
		...
		// Assert
		assert.equal(sResult, sLow, "If there is no Importance annotation fallback to " + sLow);
});
