 ...
 sap.ui.define([
	...
	QUnit.test("Method _createInitialModelForField fiscal date handling range as default value", function(assert) {
	 ...
	 QUnit.test("Method _updateMultiValueControl with ragne string numeric", function(assert) {
	 ...
	 QUnit.test("Method _associateValueHelpDialog with delayed association", function (assert) {
		 ...
		 // Act
		 this.oFilterProvider._associateValueHelpDialog(oControl, "", {}, false, false);
		 ...
		 // Act
		 this.oFilterProvider._fireEvent(FilterProvider.ASSOCIATE_VALUE_LISTS);
