...
sap.ui.define([
	...
	QUnit.test("getJSONFromAdditionalConfiguration shall convert the additional configuration into a JS Object", function(assert) {
		...
		oControlConfiguration.setHistoryEnabled(false);
		...
		assert.strictEqual(oAdditionalConfigurationHelper.controlConfiguration[0].historyEnabled, false);
		assert.strictEqual(oAdditionalConfigurationHelper.controlConfiguration[0].historyEnabledInitial, false);
