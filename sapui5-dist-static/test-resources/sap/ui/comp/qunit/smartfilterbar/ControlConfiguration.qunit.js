...
sap.ui.define([
	...
	QUnit.test("The historyEnabled of a field shall be configureable", function(assert) {
		//Call CUT
		this.oControlConfiguration.setHistoryEnabled(false);

		assert.strictEqual(this.oControlConfiguration.getHistoryEnabled(), false);
	});

	QUnit.test("A field shall be with historyEnabled by default", function(assert) {
		var bIsVisible;
		//Call CUT
		bIsVisible = this.oControlConfiguration.getHistoryEnabled();
