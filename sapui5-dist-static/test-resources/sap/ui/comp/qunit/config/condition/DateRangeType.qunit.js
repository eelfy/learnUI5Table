...
sap.ui.define([
	...
	QUnit.test("Create Controls", function (assert) {
		...
		assert.strictEqual(oFrom.parts[0].type instanceof sap.ui.model.type.NullableInteger, true, "BindingInfo type sap.ui.model.type.NullableInteger");
		...
		assert.strictEqual(oTo.parts[0].type instanceof sap.ui.model.type.NullableInteger, true, "BindingInfo type sap.ui.model.type.NullableInteger");
	...
	QUnit.test("Test onChange handler", function (assert) {
		...
		bResult = DateRangeType._IntOnChangeHandler.call(oOperation, "last 0 weeks", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntOnChangeHandler returns true");

		sState = oDateRangeType.oModel.getProperty("inputstate", oDateRangeType.getContext());
		assert.strictEqual(sState === "NONE", true, "inputstate must be NONE");

		//test _IntFromToOnChangeHandler
		oOperation = oDateRangeType.getOperation("TODAYFROMTO");
		bResult = DateRangeType._IntFromToOnChangeHandler.call(oOperation, "Today - 2 / + 2 days", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToOnChangeHandler returns true");

		sState = oDateRangeType.oModel.getProperty("inputstate", oDateRangeType.getContext());
		assert.strictEqual(sState === "NONE", true, "inputstate must be NONE");

		bResult = DateRangeType._IntFromToOnChangeHandler.call(oOperation, "Today - X / + 2 days", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToOnChangeHandler returns true");
		...
		bResult = DateRangeType._IntFromToOnChangeHandler.call(oOperation, "Today - 0 / + 0 days", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToOnChangeHandler returns true");
		...
		bResult = DateRangeType._IntFromToOnChangeHandler.call(oOperation, "Today - 10001 / + 2 days", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToOnChangeHandler returns true");

		sState = oDateRangeType.oModel.getProperty("inputstate", oDateRangeType.getContext());
		assert.strictEqual(sState === "ERROR", true, "inputstate must be ERROR");

		bResult = DateRangeType._IntFromToOnChangeHandler.call(oOperation, "Today - 1 / + 10001 days", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToOnChangeHandler returns true");

		sState = oDateRangeType.oModel.getProperty("inputstate", oDateRangeType.getContext());
		assert.strictEqual(sState === "ERROR", true, "inputstate must be ERROR");

		bResult = DateRangeType._IntFromToOnChangeHandler.call(oOperation, "Today - (-10) / + 1 days", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToOnChangeHandler returns true");

		sState = oDateRangeType.oModel.getProperty("inputstate", oDateRangeType.getContext());
		assert.strictEqual(sState === "ERROR", true, "inputstate must be ERROR");

		bResult = DateRangeType._IntFromToOnChangeHandler.call(oOperation, "Today - 1 / + (-10) days", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToOnChangeHandler returns true");
		...
		bResult = DateRangeType._IntFromToOnChangeHandler.call(oOperation, "Today - 0 / + (-1) days", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToOnChangeHandler returns true");

		sState = oDateRangeType.oModel.getProperty("inputstate", oDateRangeType.getContext());
		assert.strictEqual(sState === "ERROR", true, "inputstate must be ERROR");

		bResult = DateRangeType._IntFromToOnChangeHandler.call(oOperation, "Today - (-1) / + 0 days", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToOnChangeHandler returns true");

		sState = oDateRangeType.oModel.getProperty("inputstate", oDateRangeType.getContext());
		assert.strictEqual(sState === "ERROR", true, "inputstate must be ERROR");

		bResult = DateRangeType._IntFromToOnChangeHandler.call(oOperation, "Today - (-1) / + (-2) days", oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToOnChangeHandler returns true");
		...
		bResult = DateRangeType._IntOnChangeHandler.call(oOperation, "wrong", oDateRangeType);
		assert.strictEqual(bResult, false, "_IntFromToOnChangeHandler returns false");

		//test _DateOnChangeHanlder
		oOperation = oDateRangeType.getOperation("TODAY");
		bResult = DateRangeType._DateOnChangeHandler.call(oOperation, "Today (7/13/20)", oDateRangeType);
		assert.strictEqual(bResult, true, "_DateOnChangeHandler returns true");

		bResult = DateRangeType._DateOnChangeHandler.call(oOperation, "Today2 (7/14/20)", oDateRangeType);
	...
	QUnit.test("Test filterSuggest handler", function (assert) {
		...
		bResult = DateRangeType._IntFilterSuggestItem.call(oOperation, "0", oItem, oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFilterSuggestItem returns true");


		//test _IntFromToFilterSuggestItem
		oOperation = oDateRangeType.getOperation("TODAYFROMTO");
		bResult = DateRangeType._IntFromToFilterSuggestItem.call(oOperation, "Today - 2 / + 2 days", oItem, oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToFilterSuggestItem returns true");
		...
		bResult = DateRangeType._IntFromToFilterSuggestItem.call(oOperation, "Today - 0 / + 0 days", oItem, oDateRangeType);
		assert.strictEqual(bResult, true, "_IntFromToFilterSuggestItem returns true");

		bResult = DateRangeType._IntFromToFilterSuggestItem.call(oOperation, "Today - (-2) / + (-2) days", oItem, oDateRangeType);
		assert.strictEqual(bResult, false, "_IntFromToFilterSuggestItem returns false");

		bResult = DateRangeType._IntFromToFilterSuggestItem.call(oOperation, "Today - 10001 / + 2 days", oItem, oDateRangeType);
		assert.strictEqual(bResult, false, "_IntFromToFilterSuggestItem returns false");

		bResult = DateRangeType._IntFromToFilterSuggestItem.call(oOperation, "Today - 1 / + 10001 days", oItem, oDateRangeType);
		assert.strictEqual(bResult, false, "_IntFromToFilterSuggestItem returns false");

		bResult = DateRangeType._IntFromToFilterSuggestItem.call(oOperation, "Today - (-10) / + 1 days", oItem, oDateRangeType);
		assert.strictEqual(bResult, false, "_IntFromToFilterSuggestItem returns false");

		bResult = DateRangeType._IntFromToFilterSuggestItem.call(oOperation, "Today - 1 / + (-10) days", oItem, oDateRangeType);
		assert.strictEqual(bResult, false, "_IntFromToFilterSuggestItem returns false");
		...
		bResult = DateRangeType._IntFromToFilterSuggestItem.call(oOperation, "Today - 0 / + (-1) days", oItem, oDateRangeType);
		assert.strictEqual(bResult, false, "_IntFromToFilterSuggestItem returns false");

		bResult = DateRangeType._IntFromToFilterSuggestItem.call(oOperation, "Today - (-1) / + 0 days", oItem, oDateRangeType);
		assert.strictEqual(bResult, false, "_IntFromToFilterSuggestItem returns false");

		bResult = DateRangeType._IntFromToFilterSuggestItem.call(oOperation, "Today - (-1) / + (-2) days", oItem, oDateRangeType);
		assert.strictEqual(bResult, false, "_IntFromToFilterSuggestItem returns false");
	});
	...
	QUnit.test("Test filterSuggest _setIntControlBinding", function (assert) {
		...
		assert.strictEqual(oDescription.parts[0].type, "sap.ui.model.type.Integer");
	...
	QUnit.test("Test filterSuggest _IntOnItemsSelected", function (assert) {
		var oDateRangeType = new DateRangeType("FieldName", oFilterProvider);
		oDateRangeType.updateOperations();
		DateRangeType._IntOnItemsSelected("", {_value1: 1, _value2: 2}, oDateRangeType);
		var oModel = oDateRangeType.getModel().getData();

		assert.strictEqual(oModel.condition.value1, 1);
		assert.strictEqual(oModel.condition.value2, 2);
		assert.strictEqual(oModel.inputstate, "NONE");
		assert.strictEqual(oDateRangeType._bSuggestItemSelected, true);

		DateRangeType._IntOnItemsSelected("", {_value1: -1, _value2: 2}, oDateRangeType);
		oModel = oDateRangeType.getModel().getData();
		...
		DateRangeType._IntOnItemsSelected("", {_value1: 10, _value2: -1}, oDateRangeType);
		oModel = oDateRangeType.getModel().getData();

		assert.strictEqual(oModel.condition.value1, 10);
		assert.strictEqual(oModel.condition.value2, -1);
		assert.strictEqual(oModel.inputstate, "NONE");
		assert.strictEqual(oDateRangeType._bSuggestItemSelected, true);
	});
