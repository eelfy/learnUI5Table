...
sap.ui.define([
	...
	sap.ui.require(["sap/chart/library"], function(chartLibrary){
		...
		QUnit.test("_getDateFormatter for annotations", function (assert) {
			var iTimeStamp = 202001;
			var oField = {
				type: "Edm.String",
				isCalendarDate: false,
				"com.sap.vocabularies.Common.v1.IsCalendarYearWeek": {
			...
			var fnDateFormatter = this.oChartProvider._getDateFormatter(oField);
			assert.ok(fnDateFormatter, "For fields of annotation IsCalendarYearWeek there is a formatter function");
			var sResult = fnDateFormatter(iTimeStamp);
			assert.strictEqual(sResult, "CW 01 2020", "The time is correctly converted");
			...
			var fnDateFormatter = this.oChartProvider._getDateFormatter(oField);
			assert.ok(fnDateFormatter, "For fields of annotation IsCalendarYearMonth there is a formatter function");
			var sResult = fnDateFormatter(iTimeStamp);
			assert.strictEqual(sResult, "January 2020", "The time is correctly converted");
			...
			var fnDateFormatter = this.oChartProvider._getDateFormatter(oField);
			assert.ok(fnDateFormatter, "For fields of annotation IsCalendarYear there is a formatter function");
			var sResult = fnDateFormatter(iTimeStamp);
			assert.strictEqual(sResult, "2 January 2020", "The time is correctly converted");
			...
			var fnDateFormatter = this.oChartProvider._getDateFormatter(oField);
			assert.ok(fnDateFormatter, "For fields of annotation IsCalendarYearQuarter there is a formatter function");
			var sResult = fnDateFormatter(iTimeStamp);
			assert.strictEqual(sResult, "Q1 2020", "The time is correctly converted");
