sap.ui.define([
...
], function (TokenParser, MultiInput, library, FormatUtil, QUnit) {
	"use strict";
	...
	QUnit.test("Type operations", function (assert) {
		...
		assert.strictEqual(
			...
			'"numc":["Contains","EQ","BT","EndsWith","LT","LE","GT","GE","NotContains","NotEQ","NotBT","NotEndsWith","NotLT","NotLE","NotGT","NotGE"],' +
			'"boolean":["EQ"]}',
