...
(function() {
	...
	sap.ui.define([
		"sap/ui/comp/smarttable/SmartTable", "sap/ui/comp/util/MultiUnitUtil", "sap/m/HBox", "sap/m/Link", "sap/ui/core/Control", "sap/ui/model/analytics/AnalyticalBinding", "sap/ui/model/Context", "sap/ui/table/AnalyticalColumn", "sap/ui/model/Filter"
	], function(SmartTable, MultiUnitUtil, HBox, Link, Control, AnalyticalBinding, Context, AnalyticalColumn, Filter) {
		...
		QUnit.test("Shall open a poover for multi-unit based on the context/analytical info -- No Binding", function(assert) {
			...
			MultiUnitUtil.openMultiUnitPopover(oEvent, mMultiUnitParameters);
		...
		QUnit.test("Shall open a poover for multi-unit based on the context/analytical info -- No value/unit", function(assert) {
			var sPath = "/Items";
			var oTemplate = sinon.createStubInstance(HBox); // Dummy Template
			oTemplate.clone.returns(oTemplate); // mock clone method
			var oLink = sinon.createStubInstance(Link); // Dummy link --> Event source
		...
		QUnit.test("Shall open a poover for multi-unit based on the context/analytical info -- No AnalyticalInfo for row", function(assert) {
			var sPath = "/Items";
			var oTemplate = sinon.createStubInstance(HBox); // Dummy Template
			oTemplate.clone.returns(oTemplate); // mock clone method
			var oLink = sinon.createStubInstance(Link); // Dummy link --> Event source
		...
		QUnit.test("Shall open a poover for multi-unit based on the context/analytical info -- Grand Total", function(assert) {
			var sPath = "/Items";
			var oTemplate = sinon.createStubInstance(HBox); // Dummy Template
			oTemplate.clone.returns(oTemplate); // mock clone method
			var oLink = sinon.createStubInstance(Link); // Dummy link --> Event source
			...
			assert.strictEqual(oListBindingInfo.parameters.select, mMultiUnitParameters.value + "," + mMultiUnitParameters.unit);
		...
		QUnit.test("Shall open a poover for multi-value based on the context/analytical info -- Group / Group Total", function(assert) {
			var sPath = "/Items";
			var oTemplate = sinon.createStubInstance(HBox); // Dummy Template
			oTemplate.clone.returns(oTemplate); // mock clone method
			var oLink = sinon.createStubInstance(Link); // Dummy link --> Event source
		...
		QUnit.test("Shall open a poover for multi-unit based on the context/analytical info -- Group / Group Total - determine dimension", function(assert) {
			var sPath = "/Items";
			var oTemplate = sinon.createStubInstance(HBox); // Dummy Template
			oTemplate.clone.returns(oTemplate); // mock clone method
			var oLink = sinon.createStubInstance(Link); // Dummy link --> Event source
		...
		QUnit.test("Shall open a poover for multi-unit based on the context/analytical info -- Cell total", function(assert) {
			var sPath = "/Items";
			var oTemplate = sinon.createStubInstance(HBox); // Dummy Template
			oTemplate.clone.returns(oTemplate); // mock clone method
			var oLink = sinon.createStubInstance(Link); // Dummy link --> Event source
		...
		QUnit.test("Shall open a poover for multi-unit based on the context/analytical info -- Popover already exists", function(assert) {
			var sPath = "/Items";
			var oTemplate = sinon.createStubInstance(HBox); // Dummy Template
			oTemplate.clone.returns(oTemplate); // mock clone method
			var oLink = sinon.createStubInstance(Link); // Dummy link --> Event source
		...
		QUnit.test("Shall open a poover for multi-unit based on the context/analytical info -- filters already exists", function(assert) {
			var sPath = "/Items";
			var oTemplate = sinon.createStubInstance(HBox); // Dummy Template
			oTemplate.clone.returns(oTemplate); // mock clone method
			var oLink = sinon.createStubInstance(Link); // Dummy link --> Event source
		...
		QUnit.test("Shall open a poover for multi-unit based on the context/analytical info -- custom query paramters already exists", function(assert) {
			var sPath = "/Items";
			var oTemplate = sinon.createStubInstance(HBox); // Dummy Template
			oTemplate.clone.returns(oTemplate); // mock clone method
			var oLink = sinon.createStubInstance(Link); // Dummy link --> Event source
