...
(function() {
	...
	sap.ui.define([
	...
	], function(ODataType, StringDate, Boolean, Byte, DateTime, DateTimeOffset, Decimal, Double, Single, Guid, Int16, Int32, Int64, SByte, String, Time, FiscalDate, NumericText) {
		...
		QUnit.test("Shall return the proper Odata model type based on Odata primitive type (Edm type)", function(assert) {
			...
			oType = ODataType.getType("Edm.String", {}, {isDigitSequence: true}, {});
			assert.ok(oType instanceof NumericText);
