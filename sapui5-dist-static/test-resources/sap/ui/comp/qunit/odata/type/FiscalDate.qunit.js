...
(function () {
	...
	sap.ui.define([
		...
		function fnFormattingParsingHandlerWithDigitSequence(assert, sAnotationType, sInputData) {
		...
		QUnit.test("Formatting/Parsing com.sap.vocabularies.Common.v1.IsFiscalYear", function (assert) {
			...
			fnFormattingParsingHandlerWithDigitSequence(assert, "com.sap.vocabularies.Common.v1.IsFiscalYear", "2012");
		});
		...
		QUnit.test("Formatting/Parsing com.sap.vocabularies.Common.v1.IsFiscalPeriod", function (assert) {
			...
			fnFormattingParsingHandlerWithDigitSequence(assert, "com.sap.vocabularies.Common.v1.IsFiscalPeriod", "002");
			fnFormattingParsingHandlerWithDigitSequence(assert, "com.sap.vocabularies.Common.v1.IsFiscalPeriod", "000");
		});
		...
		QUnit.test("Formatting/Parsing com.sap.vocabularies.Common.v1.IsFiscalYearPeriod", function (assert) {
			...
			fnFormattingParsingHandlerWithDigitSequence(assert, "com.sap.vocabularies.Common.v1.IsFiscalYearPeriod", "2012002");
		...
		QUnit.test("Formatting/Parsing com.sap.vocabularies.Common.v1.IsFiscalQuarter", function (assert) {
			...
			fnFormattingParsingHandlerWithDigitSequence(assert, "com.sap.vocabularies.Common.v1.IsFiscalQuarter", "3");
		});
		...
		QUnit.test("Formatting/Parsing com.sap.vocabularies.Common.v1.IsFiscalYearQuarter", function (assert) {
			...
			fnFormattingParsingHandlerWithDigitSequence(assert, "com.sap.vocabularies.Common.v1.IsFiscalYearQuarter", "20123");
		});
		...
		QUnit.test("Formatting/Parsing com.sap.vocabularies.Common.v1.IsFiscalWeek", function (assert) {
			...
			fnFormattingParsingHandlerWithDigitSequence(assert, "com.sap.vocabularies.Common.v1.IsFiscalWeek", "51");
		});
		...
		QUnit.test("Formatting/Parsing com.sap.vocabularies.Common.v1.IsFiscalYearWeek", function (assert) {
			...
			fnFormattingParsingHandlerWithDigitSequence(assert, "com.sap.vocabularies.Common.v1.IsFiscalYearWeek", "201251");
		});
		...
		QUnit.test("Formatting/Parsing com.sap.vocabularies.Common.v1.IsDayOfFiscalYear", function (assert) {
			...
			fnFormattingParsingHandlerWithDigitSequence(assert, "com.sap.vocabularies.Common.v1.IsDayOfFiscalYear", "342");
		});
		...
		QUnit.test("FiscalDate#getFormatter returns an instance of FiscalFormat", function(assert) {
			...
			assert.ok(oFormatter.isA("sap.ui.comp.odata.FiscalFormat"), "Formatter is an instance of sap/ui/comp/odata/FiscalFormat");
		});
