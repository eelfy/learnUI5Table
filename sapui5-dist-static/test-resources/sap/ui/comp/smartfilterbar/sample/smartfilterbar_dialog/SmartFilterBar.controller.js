sap.ui.define([
	"sap/ui/thirdparty/jquery", 'sap/ui/model/odata/ODataUtils', 'sap/ui/core/mvc/Controller', "sap/ui/rta/api/startKeyUserAdaptation", 'sap/m/MessageToast', 'sap/m/SegmentedButtonItem', 'sap/ui/layout/form/Form', 'sap/ui/layout/form/FormContainer', 'sap/ui/layout/form/FormElement', 'sap/ui/layout/form/ResponsiveGridLayout', 'sap/ui/core/util/MockServer', "./SelectionVariant", 'sap/ui/comp/state/UIState', 'sap/ui/comp/filterbar/VariantConverterFrom'
], function(jQuery, ODataUtils, Controller, startKeyUserAdaptation, MessageToast, SegmentedButtonItem, Form, FormContainer, FormElement, ResponsiveGridLayout, MockServer, SelectionVariant, UIState, VariantConverterFrom) {
	"use strict";
...
//			this._outputAreaToSelectionVariant.setValue("");
		...
		onAfterVariantLoad: function(oEvent) {
			if (this._oFilterBar) {
				var oControl = this._oFilterBar.determineControlByName("CustomFilterField");
				if (oControl) {
