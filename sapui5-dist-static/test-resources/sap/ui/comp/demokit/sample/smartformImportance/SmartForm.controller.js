sap.ui.define([
	...
	return Controller.extend("sap.ui.comp.sample.smartformImportance.SmartForm", {
		...
		onInit: function () {
			...
			oMockServer.simulate("test-resources/sap/ui/comp/demokit/sample/smartformImportance/mockserver/metadata.xml", "test-resources/sap/ui/comp/demokit/sample/smartformImportance/mockserver/");
			oMockServer.start();
			...
			oModel.getMetaModel().loaded().then(function () {
				that.getView().byId("smartformImportance").bindElement("/Products('1239102')");
			});
