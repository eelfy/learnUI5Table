sap.ui.define([
	...
	return UIComponent.extend("sap.ui.comp.sample.smartfield.WithSideEffects.Component", {
		metadata: {
			rootView: {
				"viewName": "sap.ui.comp.sample.smartfield.WithSideEffects.Main",
				"type": "XML",
				"async": true
			},
			dependencies: {
		...
		init: function () {
			...
			this.oMockServer.simulate(
				"test-resources/sap/ui/comp/demokit/sample/smartfield/WithSideEffects/mockserver/metadata.xml",
				"test-resources/sap/ui/comp/demokit/sample/smartfield/WithSideEffects/mockserver/");
