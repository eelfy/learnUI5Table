sap.ui.define([
	...
	return UIComponent.extend("sap.ui.comp.sample.smartfilterbar.CustomField.Component", {
		...
		metadata: {
			rootView: {
			 "viewName": "sap.ui.comp.sample.smartfilterbar.CustomField.SmartFilterBar",
			   "type": "XML",
			  "async": true
			},
			dependencies: {
		...
		constructor: function () {
			...
			var sMockdataUrl = sap.ui.require.toUrl("sap/ui/comp/sample/smartfilterbar/CustomField/mockserver");
