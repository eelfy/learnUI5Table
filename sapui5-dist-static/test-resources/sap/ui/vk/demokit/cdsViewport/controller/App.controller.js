sap.ui.define([
	...
	"sap/m/MessageToast",
	"sap/base/Log"
], function(ContentConnector, Controller, ContentResource, ContentDeliveryService, MessageToast, Log) {
	"use strict";
	...
	return Controller.extend("sap-demo.controller.App", {
		...
		onLoadViewButtonClick: function() {
			if (cds && sourceData.veid && sourceData.viewid) {
				...
				Log.error("load view failed, invalid args");
			}
		},
