...
sap.ui.define([
    ...
    Controller.extend("sap.ushell.demotiles.abap.customDemoTile.CustomDemoTile", {
        _aDoableObject: {},
        ...
        onInit: function () {
            var oStaticTileView = this.getView(),
                ...
                oUrlParser,
                oHash,
                sBackgroundImage = jQuery.sap.getModulePath("assets") + "/custom_tile.png";
            ...
            */
            ...
            var oChip = oStaticTileView.getViewData().chip;
