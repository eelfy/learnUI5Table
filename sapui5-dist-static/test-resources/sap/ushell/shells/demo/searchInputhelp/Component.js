...
sap.ui.define([
	...
	"sap/ushell/shells/demo/searchInputhelp/BaseComponent",
	...
	}, "sap.ushell.shells.demo.searchInputhelp", "Form");

	var Component = BaseComponent.extend("sap.ushell.shells.demo.searchInputhelp.Component", {
		metadata : {
			manifest : "json"
		},
		...
		createContent : function () {
			...
			return sap.ui.view({
					...
					type : ViewType.XML,
					viewName : "sap.ushell.shells.demo.searchInputhelp.Main"
				});
		}
	});
