...
sap.ui.require([
    ...
    module("sap.ushell.CanvasShapes", {
        setup: function () {
            oCanvasShapesManager = CanvasShapesManager;
        },
    ...
    test("Shapes drawn only when a color was supplied", function () {
        ...
        themingParametersStub = sinon.stub(ThemingParameters, "get").returns("ffffff");
        oCanvasShapesManager.onThemeChanged();
        ok(mathFloorSpy.called, "Shapes drawn when color supplied");
        themingParametersStub.restore();
        mathFloorSpy.reset();

        themingParametersStub = sinon.stub(ThemingParameters, "get").returns(undefined);
        oCanvasShapesManager.onThemeChanged();
        ok(mathFloorSpy.notCalled, "Shapes not drawn when color undefined");
        themingParametersStub.restore();
        mathFloorSpy.reset();

        themingParametersStub = sinon.stub(ThemingParameters, "get").returns("transparent");
        oCanvasShapesManager.onThemeChanged();
        ok(mathFloorSpy.notCalled, "Shapes not drawn when color is transparent");
        themingParametersStub.restore();
        mathFloorSpy.reset();
