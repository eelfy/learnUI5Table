...
(function () {
    "use strict";
    /*global equal, strictEqual, module, assert, ok, test, sinon, start */
    ...
    test("check addParamsToUrl()", function () {
        ...
        sURL = sap.ushell.components.tiles.utilsRT.addParamsToUrl(sURL, data);
    ...
    test("Test edge case formatting", function () {
        ...
        strictEqual(oData.display_number_value, "17", "correct display_number_value formatting");
        strictEqual(oData.display_number_unit, "", "correct display_number_unit formatting");
        strictEqual(oData.display_icon_url, "", "correct display_icon_url formatting");
        strictEqual(oData.display_title_text, "", "correct display_title_text formatting");
        strictEqual(oData.display_number_unit, "", "correct display_number_unit formatting");
        strictEqual(oData.display_info_text, "", "correct display_info_state formatting");
        strictEqual(oData.display_info_state, "Neutral", "correct display_info_state formatting");
        strictEqual(oData.display_subtitle_text, "", "correct display_subtitle_text formatting");
        strictEqual(oData.display_state_arrow, "None", "correct display_state_arrow formatting");
        strictEqual(oData.display_number_digits, "0", "correct display_number_digits formatting");
        strictEqual(oData.display_number_factor, "K", "correct display_number_factor formatting");
        strictEqual(oData.display_search_keyword, "", "correct display_search_keyword formatting");
