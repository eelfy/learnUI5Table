...
sap.ui.require([
    ...
    QUnit.test("#check eviction:", function (assert) {
        [
            ...
            ok(iExpectedEvictions===iCountEvictions,
                oFixture.description+" check total number of evictions expecting [" + iExpectedEvictions  + "] eviction but recived [" + iCountEvictions + "] eviction.");
