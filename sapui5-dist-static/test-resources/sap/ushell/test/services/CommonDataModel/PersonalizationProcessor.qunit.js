...
sap.ui.require([
    ...
    QUnit.test("_extractPersonalizationDeltaForTile: Returns false if the corresponding original item is not accessible from the extract helper parameter as specified", function () {
        // Arrange
    ...
    QUnit.test("_extractPersonalizationDeltaForTile: Returns false if the original item was not personalized.", function () {
        // Arrange
        var oPersonalizationProcessor = new PersonalizationProcessor();
        var oExtractHelper = {
            oHashedItemsOriginal: {
    ...
    QUnit.test("_extractPersonalizationDeltaForTile: Does not register a delta if an implicit default gets applied.", function () {
        // Arrange
        var oPersonalizationProcessor = new PersonalizationProcessor();
        var oExtractHelper = {
            oHashedItemsOriginal: {
    ...
    QUnit.test("_extractPersonalizationDeltaForTile: Detects when the title, the sub title, the tile info or the display hint of a tile have been personalized", function () {
        // Arrange
        var oPersonalizationProcessor = new PersonalizationProcessor();
        var oExtractHelper = {
            oHashedItemsOriginal: {
    ...
    [{
        ...
        var testDescription = "_applyTileSettings: " +
