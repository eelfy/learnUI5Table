...
sap.ui.require([
    ...
    "use strict";
    /* global test, strictEqual, ok, deepEqual, equal, notStrictEqual
      module, assert, asyncTest, start, QUnit */
    ...
    test("with ShellNavigation", function () { //TODO use sinon the way it is supposed to...
        ...
        stub = sinon.stub(oShellNavigationService, "hrefForExternal").callsFake(function (oArgs, oArgs2, oArgs3) {
            lastCall = oArgs;
            return oArgs;
        });
        ...
        oCrossApplicationNavigationService = sap.ushell.Container.getService("CrossApplicationNavigation");
        stub = sinon.stub(sap.ushell.Container.getService("ShellNavigation"), methodName).callsFake(function (oArgs, oArgs1) {
            lastCall = oArgs;
            return oArgs;
        });
        ...
        oCrossApplicationNavigationService = sap.ushell.Container.getService("CrossApplicationNavigation");
        stub = sinon.stub(sap.ushell.Container.getService("ShellNavigation"), methodName).callsFake(function (oArgs) {
            lastCall = oArgs;
            return oArgs;
        });
    ...
    [
        ...
        {
            testDescription: " sap-app-origin-hint present on resolution result, no component alon",
            aIntents: ["#SO-act2?p1=v1&sap-system=CC2"],
            oCurrentApplication: {
    ...
    test("isInitialNavigation: logs an error message and returns true if the shell navigation service is not availble", function () {
        ...
        var iCallCount = jQuery.sap.log.debug.getCalls().length;
        strictEqual(iCallCount, 1, "jQuery.sap.log.debug was called 1 time");
        ...
        test("isInitialNavigation: returns " + oFixture.expectedResult + " if the isInitialNavigation method from ShellNavigation service returns " + oFixture.bResultFromShellNavigation, function () {
            ...
            oGetServiceStub.withArgs("ShellNavigation").returns({
                isInitialNavigation: function () {
                    return oFixture.bResultFromShellNavigation;
                }
            });
    ...
    [
        ...
        asyncTest("createComponentInstance: create a new component for a valid navigation intent " + sNavigationIntent, 5, function () {
            var oMockComponentInstance = {},
                oNavTargetResolutionStub = sinon.stub(sap.ushell.Container.getService("NavTargetResolution"), "resolveHashFragment").callsFake(fnResolveHashFragmentMock),
                oSapUiComponentStub = sinon.stub(sap.ui, "component").callsFake(fnSapUiComponentMock.bind(oMockComponentInstance));
    ...
    asyncTest("createComponentInstance: clp appruntime use case", 5, function () {
        var oMockComponentInstance = {},
            oNavTargetResolutionStub = sinon.stub(sap.ushell.Container.getService("NavTargetResolution"), "resolveHashFragment").callsFake(fnResolveHashFragmentMock),
            oSapUiComponentStub = sinon.stub(sap.ui, "component").callsFake(fnSapUiComponentMock.bind(oMockComponentInstance)),
            oInAppRuntimeStub = sinon.stub(sap.ushell.Container, "inAppRuntime").returns(true);

        sap.ui.define("sap/ushell/appRuntime/ui5/services/AppLifeCycleAgent", [], function () {
            return {
                getAppInfo: function () {
        ...
        sap.ushell.Container.getService("CrossApplicationNavigation").createComponentInstance("foo-appruntime")
            .done(function (oComponentInstance) {
                start();
                ok(oNavTargetResolutionStub.calledOnce, "NavTargetResolution service gets called");
                ok(oNavTargetResolutionStub.calledWith("#foo-appruntime"), "called with correct parameter");
                ok(oSapUiComponentStub.calledOnce, "sap.ui.compoment was called once!");
                ok(oSapUiComponentStub.calledWith({
                    applicationType: "URL",
                    async: true,
    ...
    [
        ...
        asyncTest(
            "#createComponentInstance throws when passed an unexpected `oConfig` argument", 1,
            function () {
                ...
                oCrossAppNavService.createComponentInstance(sIntent, oFixture.oConfig)
                    .done(function() {
                        start();
                    ...
                    .fail(function(sError) {
                        start();
                        strictEqual(sError, rError, oFixture.sAssertion);
                    });
            }
        );
    });
    ...
    [
        ...
        asyncTest("createComponentInstance: runWithOwner owner properly propagated " + oFixture.description, 2, function () {
            var oNavTargetResolutionStub = sinon.stub(sap.ushell.Container.getService("NavTargetResolution"), "resolveHashFragment").callsFake(fnResolveHashFragmentMock2),
                oOwnerComponent;
    ...
    asyncTest("createComponentInstance: create component with startup parameters", 3, function () {
        ...
        sinon.stub(jQuery.sap, "isDeclared").callsFake(function (sModuleName) {
    ...
    asyncTest("createComponentInstance: resolving NWBC nav target", 3, function () {
        var oNavTargetResolutionStub = sinon.stub(sap.ushell.Container.getService("NavTargetResolution"), "resolveHashFragment").callsFake(fnResolveHashFragmentMock),
    ...
    QUnit.test(
        ...
        function (assert) {
            ...
            sinon.stub(sap.ushell.Container.getService("NavTargetResolution"), "resolveHashFragment").callsFake(function resolveHashFragmentWithAsyncHints (sIntent) {
            ...
            oSapUiComponentStub = sinon.stub(sap.ui, "component").callsFake(fnSapUiComponentMock.bind({}));
    ...
    QUnit.test(
        ...
        function (assert) {
            ...
            sinon.stub(sap.ushell.Container.getService("NavTargetResolution"), "resolveHashFragment").callsFake(function (sIntent) {
                    return fnResolveHashFragmentMock(sIntent)
                        .then(function (oAppProperties) {
                            oAppProperties.applicationDependencies = {
                                asyncHints: {
    ...
    [
        ...
        asyncTest("createComponenData: returns a component data for a valid navigation intent " + sNavigationIntent, function () {
            var oNavTargetResolutionStub = sinon.stub(sap.ushell.Container.getService("NavTargetResolution"), "resolveHashFragment").callsFake(fnResolveHashFragmentMock);
            sap.ushell.Container.getService("CrossApplicationNavigation").createComponentData(sNavigationIntent)
                .then(function (oComponentData) {
                    ...
                    ok(oNavTargetResolutionStub.calledOnce, "NavTargetResolution service gets called");
                    ok(oNavTargetResolutionStub.calledWith("#foo-bar"), "called with correct parameter");
                    deepEqual(oComponentData, oExpectedData, "Correct component data returned!");
                });
        });
    });
    [
        ...
        asyncTest("createComponentData: Invalid navigation intent", function () {
            var oNavTargetResolutionStub = sinon.stub(sap.ushell.Container.getService("NavTargetResolution"), "resolveHashFragment").callsFake(fnResolveHashFragmentMock);

            sap.ushell.Container.getService("CrossApplicationNavigation").createComponentData(sNavigationIntent)
                .then(testUtils.onError)
    ...
    [
        ...
        test("hrefForExternal: appends sap-ushell-enc, sap-ushell-navmode and sap-app-origin-hint before inner app route when " + oFixture.testDescription, function () {
            var oCrossAppNavService = sap.ushell.Container.getService("CrossApplicationNavigation");
    ...
    [
        ...
        test("hrefForExternal: appends sap-ushell-enc, sap-ushell-navmode and sap-app-origin-hint (empty string) before inner app route when " + oFixture.testDescription, function () {
            var oCrossAppNavService = sap.ushell.Container.getService("CrossApplicationNavigation");
    ...
    [ { sUrl: "https://www.google.de", bResult: true},
        ...
        asyncTest("isUrlSupported diverse links: " + oFixture.sUrl + "  force reject:" + oFixture.reject, function () {
            var oCrossAppNavigationService = sap.ushell.Container.getService("CrossApplicationNavigation");
            sinon.stub(oCrossAppNavigationService, "isIntentSupported").callsFake(function (aIntent) {
                var oDeferred = new jQuery.Deferred(),
                    bSupported = false,
                    oRes = {};
    ...
    [ {
        testDescription: "correct url is returned after resolving intent ",
        oIntent: "#Test-config",
        expectedURL: {url: "/sap/bc/ui5_ui5/ui2/ushell/test-resources/sap/ushell/demoapps/FioriSandboxConfigApp"}
    }
    ].forEach(function (oFixture) {
        asyncTest(oFixture.testDescription + oFixture.oIntent, function () {
            sap.ushell.Container.getServiceAsync("CrossApplicationNavigation").then(function (oService) {
                oService.resolveIntent(oFixture.oIntent).then(function (oRes) {
                    start();
                    deepEqual(oRes, oFixture.expectedURL);
                });
            });
        });
    });
