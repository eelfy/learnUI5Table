...
sap.ui.require([
    ...
    /* global asyncTest, strictEqual, deepEqual, equal, module, QUnit, ok, start, test, throws, sinon, notDeepEqual */
    ...
    asyncTest("_createContainer when there is component but no shared scope", function () {
        ...
        this.oService._createContainer("ContainerKey", oScope, false, this.oComponent).always(function () {
            ...
            strictEqual(this.fnContextContainerSpy.firstCall.args[2], "sap.ushell.personalization#ContainerKey#AppVarId");
