...
sap.ui.require([
    ...
    "sap/base/Log"
], function (oUi5ComponentLoaderUtils, Ui5ComponentHandle, oTestUtils, Log) {
    "use strict";
    ...
    [
        ...
        QUnit.test("CoreResourcesComplement Loading - loadBundle doesn't get executed when " + oFixture.testDescription, function (assert) {
            ...
            // Assert
            assert.strictEqual(oLogErrorSpy.callCount, oFixture.expectedCalls.error, "Log.error has been called for the correct amount of times;");
            assert.strictEqual(oLogErrorSpy.firstCall.args[0], oFixture.expectedCalls.errorMessage, "Log.error was called with the correct argument");
        });
    });
    ...
    [
        ...
        QUnit.test("CoreResourcesComplement Loading - loadBundle " + oFixture.testDescription, function (assert) {
            // Arrange
            var oErrorStub = sinon.stub(Log, "error"),
                fnDone = assert.async();
