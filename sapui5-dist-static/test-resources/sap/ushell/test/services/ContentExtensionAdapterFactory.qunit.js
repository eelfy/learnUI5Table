...
sap.ui.require([
...
], function (ContentExtensionAdapterFactory, FeaturedGroupMock, ContentExtensionAdapterConfig, Config, System, ObjectPath) {
    "use strict";
    ...
    QUnit.module("The function _getAdapterInstance", {
        beforeEach: function () {
            this.oGetObjectStub = sinon.stub(ObjectPath, "get");
        },
        afterEach: function () {
