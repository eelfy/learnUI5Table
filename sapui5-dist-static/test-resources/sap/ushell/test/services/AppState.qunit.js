...
sap.ui.require([
    ...
    /* global asyncTest, deepEqual, equal, QUnit, ok, QUnit, start, test, sinon, strictEqual */
        ...
        sap.ushell.bootstrap("local").then(function () {
            ...
            oAppState.save().done(function () {
                oService.getAppState("AKEY1234").done(function (oAppState) {
                    ...
                    ok(oAppState._sPersistencyMethod === AppStatePersistencyMethod.PersonalState, "PersistencyMethod ok");
    ...
    asyncTest("AppState getAppState fails when no window cache is available and opener is FLP"
    ...
    asyncTest("AppState getAppState read from Backend when no window cache is available and opener is FLP"
    ...
    QUnit.module("createEmptyAppState", {
        beforeEach: function (assert) {
            ...
            sap.ushell.bootstrap("local").then(function () {
                fnDone();
                this.oPersonalizationStub = sinon.stub(sap.ushell.Container, "getService");
                this.oPersonalizationStub.withArgs("Personalization").returns({
                    getGeneratedKey: sinon.stub().returns("KEYA")
                });
                this.oService = new AppState(new sap.ushell.adapters.mock.AppStateAdapter());
                this.oComponent = new sap.ui.core.UIComponent();
            }.bind(this));
        },
        afterEach: function () {
            this.oPersonalizationStub.restore();
            delete sap.ushell.Container;
        }
    });
