...
sap.ui.require([
    ...
    [
        ...
        {
            testDescription: "inbound has a contentProviderId and refers to a user default value",
            expectedMatch: true, // match occurs but is a potential match...
            expectedMissingUserDefaultRefsOut: { // ... because the value of this default parameter is unknown
                someValidContentProviderId: {
                    "UserDefault.currency": true
                }
            },
            sShellHash: "#SO-act",
            ...
            oInbound: {
                semanticObject: "SO",
                action: "act",
                contentProviderId: "someValidContentProviderId",
                signature: {
                    parameters: {
                        currency: {
                            required: false,
        ...
        },
        {
            ...
            expectedMissingUserDefaultRefsOut: {
                "": {} // no output refs as value was provided
            },
            sShellHash: "#SO-act",
            oKnownUserDefaultRefsIn: {
                "": {
                    "UserDefault.currency": "value" // default value is given
                }
            },
            oInbound: {
                semanticObject: "SO",
        ...
        },
        {
            ...
            oKnownUserDefaultRefsIn: {
                "": {
                    "User.env.sap-language": "value" // default value is given
                }
            },
            oInbound: {
                semanticObject: "SO",
...

        {
            ...
            oKnownUserDefaultRefsIn: {
                "": {
                    "UserDefault.currency": "EUR" // known user default
                }
            },
            oInbound: {
                semanticObject: "SO",
        ...
        {
            testDescription: "inbound has a contentProviderId, filter reference is known and filter is matching",
            expectedMatch: true,
            expectedMissingUserDefaultRefsOut: {
                someValidContentProviderId: {} // no output refs as value was provided
            },
            sShellHash: "#SO-act?currency=EUR",
            oKnownUserDefaultRefsIn: {
                someValidContentProviderId: {
        ...
        },
        {
            ...
            oKnownUserDefaultRefsIn: {
                "": {
                    "UserDefault.currency": "USD" // NOTE: USD
                }
            },
            oInbound: {
                semanticObject: "SO",
        ...
        {
            testDescription: "inbound has a contentProviderId, filter reference is known and filter is not matching",
            expectedMatch: false,
            expectedMissingUserDefaultRefsOut: {
                someValidContentProviderId: {}
            },
    ...
    (function () {
        ...
        var oSampleInboundWithParameterMapping = {
            ...
            contentProviderId: "someContentProviderId"
        };
    ...
    [
        {
            ...
            expectedSortString: "AIDM=0 CURCP=0 x TECM=0 MTCH=005 MREQ=003 NFIL=002 NDEF=002 POT=006 RFRE=998 TECP=2"
        },
        {
            ...
            expectedSortString: "AIDM=0 CURCP=0 x TECM=2 MTCH=005 MREQ=003 NFIL=002 NDEF=002 POT=005 RFRE=998 TECP=2"
        },
        {
            ...
            expectedSortString: "AIDM=0 CURCP=0 x TECM=0 MTCH=005 MREQ=003 NFIL=002 NDEF=002 POT=005 RFRE=998 TECP=2"
        },
        {
            ...
            expectedSortString: "AIDM=1 CURCP=0 x TECM=0 MTCH=005 MREQ=003 NFIL=002 NDEF=002 POT=005 RFRE=998 TECP=2"
        },
        {
            /*
            ...
            expectedSortString: "AIDM=0 CURCP=0 x TECM=0 MTCH=000 MREQ=000 NFIL=000 NDEF=000 POT=000 RFRE=999 TECP=2"
        },
        {
            /*
    ...
    QUnit.module("sap-app-origin-hint parameter", {
        beforeEach: function () {
            this.oSampleInbound = {
                semanticObject: "Object",
                action: "action",
    ...
    QUnit.test("_matchToInbound: returns expected sort string with CURCP=0 when contentProviderId is not defined in inbound", function (assert) {
        var expectedSortString = "AIDM=0 CURCP=0 x TECM=0 MTCH=000 MREQ=000 NFIL=000 NDEF=000 POT=000 RFRE=999 TECP=2";
        this.oParsedShellHash.params = {
            "sap-app-origin-hint": ["origin1"]
        };

        var oMatchResult = oSearch.matchOne(this.oParsedShellHash, this.oSampleInbound, {}, {});
        ...
        assert.strictEqual(oMatchResult.priorityString, expectedSortString, "Got Expected priority string");
    });

    QUnit.test("_matchToInbound: returns expected sort string with CURCP=0 when contentProviderId and sap-app-origin-hint are different", function (assert) {
        var expectedSortString = "AIDM=0 CURCP=0 x TECM=0 MTCH=000 MREQ=000 NFIL=000 NDEF=000 POT=000 RFRE=999 TECP=2";

        this.oParsedShellHash.params = {
            "sap-app-origin-hint": ["origin1"]
        };
        this.oSampleInbound.contentProviderId = "origin2";
    ...
    QUnit.test("_matchToInbound: returns sort string with CURCP=0 when contentProviderId is defined and sap-app-origin-hint - not", function (assert) {
        var expectedSortString = "AIDM=0 CURCP=0 x TECM=0 MTCH=000 MREQ=000 NFIL=000 NDEF=000 POT=000 RFRE=999 TECP=2";
    ...
    QUnit.test("_matchToInbound: returns sort string with CURCP=1 when contentProviderId === sap-app-origin-hint", function (assert) {
        var expectedSortString = "AIDM=0 CURCP=1 x TECM=0 MTCH=000 MREQ=000 NFIL=000 NDEF=000 POT=000 RFRE=999 TECP=2";

        this.oParsedShellHash.params = {
            "sap-app-origin-hint": ["origin1"]
        };
        this.oSampleInbound.contentProviderId = "origin1";
    ...
    QUnit.test("_matchToInbound: returns sort string with CURCP=1 when contentProviderId and sap-app-origin-hint are both an empty string", function (assert) {
        var expectedSortString = "AIDM=0 CURCP=1 x TECM=0 MTCH=000 MREQ=000 NFIL=000 NDEF=000 POT=000 RFRE=999 TECP=2";

        this.oParsedShellHash.params = {
            "sap-app-origin-hint": [""]
        };
        this.oSampleInbound.contentProviderId = "";
    ...
    QUnit.test("sortMatchingResultsDeterministic: prioritize result with the same origin", function (assert) {
        this.oParsedShellHash.params = {
            "sap-app-origin-hint": ["origin1"]
        };

        var oMatchResult1 = oSearch.matchOne(utils.clone(this.oParsedShellHash), utils.clone(this.oSampleInbound), {}, {});

        this.oSampleInbound.contentProviderId = "origin1";
        var oMatchResult2 = oSearch.matchOne(utils.clone(this.oParsedShellHash), utils.clone(this.oSampleInbound), {}, {});

        this.oSampleInbound.contentProviderId = "origin2";
        var oMatchResult3 = oSearch.matchOne(utils.clone(this.oParsedShellHash), utils.clone(this.oSampleInbound), {}, {});

        var aSortedResult = oSearch.sortMatchingResultsDeterministic([oMatchResult1, oMatchResult2, oMatchResult3]);

        assert.deepEqual(aSortedResult, [oMatchResult2, oMatchResult1, oMatchResult3], "Got Expected order");
    });

    QUnit.module("fnContentProviderLoader", {
        beforeEach: function () {
            this.oParseSrvc = new URLParsing();
            this.oInbound = {
                semanticObject: "SO",
                action: "aBC",
    ...
    QUnit.test("Not matched when there is no data origin in the content provider lookup", function (assert) {
        var fnDone = assert.async();

        var sHash = "#SO-aBC?sap-system=ALIAS1",
            oParsedShellHash = this.oParseSrvc.parseShellHash(sHash),
            oLookup = {
                CP1: {
                    ALIAS2: true,
                    SYSTEM1: true
            ...
            oGetLookupStub = sinon.stub().returns(new jQuery.Deferred().resolve(oLookup).promise());
        ...
        oSearch.match(
            ...
            assert.ok(true, "promise was resolved");
            assert.ok(oGetLookupStub.calledOnce, "lookup was loaded");

            var bMatches = oMatchResults.matchResults.length > 0;

            assert.strictEqual(bMatches, false, "inbound and intent should not be matched");
    ...
    QUnit.test("Matched when data origin is in the content provider lookup", function (assert) {
        var fnDone = assert.async();

        var sHash = "#SO-aBC?sap-system=ALIAS2",
            oParsedShellHash = this.oParseSrvc.parseShellHash(sHash),
            oLookup = {
                CP1: {
                    ALIAS2: true,
        ...
        oSearch.match(
            ...
            assert.strictEqual(bMatches, true, "inbound and intent matched");
    ...
    QUnit.test("Matched when data origin is in the content provider lookup (local content provider)", function (assert) {
        var fnDone = assert.async();
        ...
        // Note: empty content provider id should be treated just like another
        // content provider id
        this.oInbound.contentProviderId = "";
    ...
    QUnit.test("Not matched when data origin is in the content provider lookup (local content provider)", function (assert) {
        var fnDone = assert.async();
