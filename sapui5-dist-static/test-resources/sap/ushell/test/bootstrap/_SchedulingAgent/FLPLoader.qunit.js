...
sap.ui.require([
    ...
    QUnit.test("Load component by component create", function (assert) {
        ...
        var oSpyComponentCreate = sinon.stub(Component, "create").returns(Promise.resolve("This should be a stub!"));

        //Act
        FLPLoader.loadComponentByComponentCreate(oStep).then(function (sTestStep) {
            //Assert
