...
/**
 * @fileOverview QUnit tests for module "AppForInbound" in "sap/ushell/adapters/cdm/util/AppForInbound"
 * "
 */
/* global QUnit, sinon */
sap.ui.require([
    ...
    QUnit.test("Raises an exception if the application type is unknown.", function (assert) {
        ...
        assert.throws(function () {
            AppForInbound.get(sInboundPermanentKey, oInboundUnknownApplicationType);
        }, "Raises an exception");
    });
    //#endregion
