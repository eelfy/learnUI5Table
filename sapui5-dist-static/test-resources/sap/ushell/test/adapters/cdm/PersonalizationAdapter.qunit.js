...
sap.ui.define([
    ...
    QUnit.test("PersonalizationAdapter", function (assert) {
        ...
        assert.throws(function () {
            // act
            new oAdapterInternals.PersonalizationAdapter(
    ...
    QUnit.test("PersonalizationAdapter: construct an http client with the expected configuration", function (assert) {
        var oFnHttpClientStub = sinon.stub(),
            oConfig = {
                config: {
                    storageResourceRoot: "path/to/storage/resource/location/"
                }
...
This test doesn't test anything meaningful...
        ...
        oFixture = {
            ...
            input: {
                ...
                containersCache: {
                    "resource-root/u/container-key.json": oCachedContainer
                },
