...
sap.ui.require([
    ...
    function stubUsedServices (oSite, oServiceSpecifications) {
        ...
        var oOriginalCSTRService = sap.ushell.Container.getService("ClientSideTargetResolution");
        ...
        var oClientSideTargetResolutionService = {
            ...
            isInPlaceConfiguredFor: oOriginalCSTRService.isInPlaceConfiguredFor
        };
    ...
    QUnit.test("getCatalogTileSize: without tile size", function (assert) {
        ...
        // assert
        strictEqual(sSize, expectedSize, "returned size 1x1, if no size was given before ");
    ...
    QUnit.test("getCatalogTileSize: 1x2 tile ", function (assert) {
        ...
        // assert
        strictEqual(sSize, expectedSize, "returned expected size 1x2");
    ...
    [
        {
            ...
            input: {
                oCatalogA: {
                    identification: { id: "A", title: "A" }
                },
                oCatalogB: {
                    identification: { id: "B", title: "B" }
                }
            },
            expectedResult: -1
        }, {
    ...
    [
        {
            ...
            expectedCatalogs: [
                "3rdPartyCatalog1",
                "cat2", // Title starts with Accounts
                "cat1", // Title starts with cat1
                "customTileCatalog",
                "pluginCatalog",
                "urlTileCatalog"
            ]
