...
(function () {
    ...
    oCdmData.site =
    {
        ...
        applications: {
            ...
            AppPhone: {
                "sap.app": {
                    title: "App phone title",
                    subTitle: "only Phones",
                    tags: {
                        keywords: [
                            "keyword1 - App3",
                            "keyword2 - App3"
                ...
                payload: {
                    tiles: [
                        ...
                        },
                        {
                            ...
                            id: "13",
                            icon: "sap-icon://favorite",
                            title: "Bookmark title 13",
                            target: {
                                semanticObject: "SO",
                                action: "action",
                                appSpecificRoute: "&/test/123"
                            },
                            isBookmark: true
                        }, {
                            id: "14",
                            icon: "sap-icon://world",
                            title: "Bookmark title 14",
                            target: {
                                semanticObject: "SO",
                                action: "action",
                                appSpecificRoute: "&/test/123"
        ...
        visualizations: {
            ...
            AppPhone: {
                vizType: "sap.ushell.StaticAppLauncher",
                businessApp: "AppPhone.BusinessApp",
                vizConfig: {
                    "sap.flp": {
                        target: {
                            appId: "AppPhone",
    ...
    oLpaData.catalogTiles = {
        ...
        // App should not be returned as it is filtered by form factor
        AppPhone: {
            id: "AppPhone",
            tileIntent: "#AppPhone-viaStatic?sap-ui-app-id-hint=AppPhone",
            tileResolutionResult: {
                contentProviderId: "",
                appId: "AppPhone",
                dataSources: undefined,
    ...
    oCstrData.resolvedTileHashes = {
        ...
        "#AppPhone-viaStatic": {
            icon: "sap-icon://Fiori2/F0023",
            appId: "AppPhone",
            subTitle: "subtitle - AppPhone",
            tileComponentLoadInfo: "#AppPhone-viaStatic",
            title: "App phone title"
        },
        "#App3-viaStatic": {
