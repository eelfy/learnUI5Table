...
sap.ui.require([
    ...
    "sap/ushell/utils",
    "sap/ushell/System"
], function (testUtils, utils, System) {
    "use strict";
    /*global assert, asyncTest, expect, module, start, sinon */
    ...
    asyncTest("check that system properties are set in the system correctly", function () {
        var oSystem = new System({alias: "myAlias", platform: "cdm"}),
            sParameter,
            oAdapterConfig,
            oAdapter;
