...
sap.ui.require([
    ...
    QUnit.test("Adds a local systemAlias", function (assert) {
        ...
        // Act
        var oAdapter = new ClientSideTargetResolutionAdapter({}, undefined, undefined);
    ...
    [
        ...
        QUnit.test("returns the correct inbounds when " + oFixture.testDescription, function (assert) {
            ...
            // Act
            oAdapter = new ClientSideTargetResolutionAdapter(oSystem, undefined, oFixture.oAdapterConfig);
    ...
    QUnit.test("Rejects when systemalias is not avaliable", function (assert) {
        // Arrange
        var done = assert.async();
        ...
        this.oAdapter.resolveSystemAlias("someMissingSystemAlias")
            ...
            .fail(function (sError) {
                ...
                assert.strictEqual(sError, "No system alias value available", "returned the correct error message");
            })
            .always(done);
    });
});
