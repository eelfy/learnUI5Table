...
sap.ui.require([
    ...
    [
        {
            testDescription: "UI5 application with no existing technical parameter in reserved parameters and manifest",
        ...
        {
            testDescription: "UI5 application with existing technical parameter in reserved parameters",
            sParameterName: "sap-fiori-id",
            oComponent: createFakeComponent({
        ...
        {
            testDescription: "UI5 application with existing technical parameter in manifest",
            sParameterName: "sap-fiori-id",
            oComponent: createFakeComponent({
                technicalParameters: {},
        ...
        {
            testDescription: "UI5 application with existing technical parameter in reserved parameters and manifest",
            sParameterName: "sap-fiori-id",
            oComponent: createFakeComponent({
        ...
        {
            testDescription: "non UI5 application with existing technical parameter",
            sParameterName: "sap-fiori-id",
        ...
        {
            testDescription: "from a non UI5 application with no existing technical parameter",
            sParameterName: "sap-fiori-id",
            oApplicationContainer: {
                getReservedParameters: function () {
                    return {};
        ...
        {
            testDescription: "with sap-ui-fl-version",
            sParameterName: "sap-ui-fl-version",
            oComponent: createFakeComponent({
                technicalParameters: { "sap-ui-fl-version": 3 },
                manifestRegistrationIds: []
            }),
            expectedResult: 3,
            expectedReject: false
        ...
        QUnit.test("getParameterValue: returns the correct array of values when " + oFixture.testDescription, function (assert) {
            ...
            // Act
            oTechnicalParameters.getParameterValue(
                oFixture.sParameterName,
                oFixture.oComponent,
                oFixture.oApplicationContainer,
                oFixture.sApplicationType)
