...
sap.ui.define([
    ...
    test("setAccessibilityMode logs an error if it is not allowed to set the accessibility mode", function () {
        ...
        strictEqual(Log.error.getCall(0).args[0], "setAccessibilityMode not permitted",
    ...
    [
        ...
        test("sap.ushell.User: setContentDensity logs an error when " + oFixture.testDescription, function () {
            ...
            strictEqual(Log.error.getCall(0).args[0], "setContentDensity not permitted",
                "expected error message was logged");
    ...
    test("The fullName property is not given", function (assert) {
        // Arrange
        var oUser = new sap.ushell.User({});
    ...
    test("The fullName property consists of 1 name", function (assert) {
        // Arrange
        var oUser = new sap.ushell.User({
            fullName: "Joe"
        });
    ...
    test("The fullName property consists of 2 names", function (assert) {
        // Arrange
        var oUser = new sap.ushell.User({
            fullName: "Joe Doe"
        });
    ...
    test("The fullName property consists of 3 names", function (assert) {
        // Arrange
        var oUser = new sap.ushell.User({
    ...
    test("The fullName property consists of special symbols", function (assert) {
        // Arrange
        var oUser = new sap.ushell.User({
    ...
    test("The fullName property consists of numbers", function (assert) {
        // Arrange
        var oUser = new sap.ushell.User({
            fullName: "1234 5678"
        });
    ...
    test("The fullName property consists of a name with to many spaces", function (assert) {
        // Arrange
        var oUser = new sap.ushell.User({
            fullName: " Some  Name "
        });
    ...
    test("The fullName property consists of lowercase name parts", function (assert) {
        // Arrange
        var oUser = new sap.ushell.User({
