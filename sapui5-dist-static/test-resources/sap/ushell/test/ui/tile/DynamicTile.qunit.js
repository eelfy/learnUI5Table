...
(function () {
    "use strict";
    /*global asyncTest, module, start, strictEqual, test, ok */
    ...
    test("Constructor Test", function () {
        strictEqual(dynamicTile.getNumberUnit(), demiTileData.numberUnit, "Number Unit Test");
        strictEqual(dynamicTile.getNumberFactor(), demiTileData.numberFactor, "Number Factor Test");
        //Test constructor arguments with default values
        strictEqual(dynamicTile.getNumberValue(), "0.0", "Number Value Test");
        strictEqual(dynamicTile.getNumberState(), "Neutral", "Number State Test");
        strictEqual(dynamicTile.getNumberDigits(), 0, "Number Digits Test");
        strictEqual(dynamicTile.getStateArrow(), "None", "State Arrow Test");
    });
