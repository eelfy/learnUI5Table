...
sap.ui.require([
    ...
    /*global module, test, sinon, asyncTest, start*/
    ...
    test("test lifecycle basic flow", function (assert) {
        ...
        var oGetAppInfoStub = sinon.stub(AppLifeCycleAgent, "getAppInfo", function () {
                return new jQuery.Deferred().resolve({test: 1}).promise();
            }),
