...
sap.ui.require([
    ...
    "sap/base/Log"
], function (URI, oGuiResolution, URLParsing, oTestUtils, oSystemAlias, Log) {
    "use strict";
    ...
    [
        ...
        QUnit.test("injectEffectiveParametersIntoWebguiPobjectParam: works as expected when " + oFixture.testDescription, function (assert) {
            ...
            var iLogFunctionCallCount = Log.error.getCalls().length;
    ...
    [
        ...
        {
            testDescription: "transaction without parameters and parameters to interpolate and DYNP_SKIP_SEL_SCREEN=0",
            sQuery: "?%7etransaction=SU01",
            oParamsToInject: {
                "Param1" : ["Value1"],
                "Param2" : ["Value2"],
        ...
        {
            testDescription: "transaction without parameters and parameters to interpolate and DYNP_SKIP_SEL_SCREEN=0 number",
            sQuery: "?%7etransaction=SU01",
            oParamsToInject: {
                "Param1" : ["Value1"],
                "Param2" : ["Value2"],
        ...
        {
            testDescription: "transaction without parameters and parameters to interpolate and DYNP_SKIP_SEL_SCREEN=[empty string]",
            sQuery: "?%7etransaction=SU01",
            oParamsToInject: {
                "Param1" : ["Value1"],
                "Param2" : ["Value2"],
        ...
        {
            testDescription: "transaction without parameters and parameters to interpolate and DYNP_SKIP_SEL_SCREEN=[space character]",
            sQuery: "?%7etransaction=SU01",
            oParamsToInject: {
                "Param1" : ["Value1"],
                "Param2" : ["Value2"],
        ...
        {
            testDescription: "transaction without parameters and parameters to interpolate and DYNP_SKIP_SEL_SCREEN=False",
            sQuery: "?%7etransaction=SU01",
            oParamsToInject: {
                "Param1" : ["Value1"],
                "Param2" : ["Value2"],
        ...
        {
            testDescription: "transaction without parameters with trailing %20 and parameters to interpolate and DYNP_SKIP_SEL_SCREEN=0 string",
            sQuery: "?%7etransaction=SU01%20",
            oParamsToInject: {
                "DYNP_SKIP_SEL_SCREEN": ["0"],
                "Param1" : ["Value1"],
        ...
        QUnit.test("injectEffectiveParametersIntoWebguiQueryParam: works as expected when " + oFixture.testDescription, function (assert) {
            ...
            var iLogFunctionCallCount = Log.error.callCount;
