...
sap.ui.require([
    ...
    [{
        ...
        description: "Navigation to home should return FLP_BACK step",
        sourceApplication: "F123",
        targetApplication: "FLP_HOME",
        expectedStep: "FLP_BACK@F123"
    }, {
        ...
        description: "Open PageRuntime",
        sourceApplication: undefined,
        targetApplication: "FLP_PAGE",
        expectedStep: "FLP@LOAD"
    }, {
        description: "Open classical homepage",
        sourceApplication: undefined,
        targetApplication: "FLP_HOME",
        expectedStep: "FLP@LOAD"
    }, {
        ...
        QUnit.test(oTestCase.description, function (assert) {
            ...
            oStatisticalRecord.closeRecord();
            assert.strictEqual(oStatisticalRecord.getStep(), oTestCase.expectedStep, "Correct step was calculated");
