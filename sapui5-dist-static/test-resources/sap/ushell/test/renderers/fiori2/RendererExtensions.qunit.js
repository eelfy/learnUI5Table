...
(function () {
    ...
    module("sap.ushell.renderers.fiori2.RendererExtensions", {
        ...
        setup: function () {
            ...
            EventHub.once("RendererLoaded").do(function () {
                ...
                oGetDomRefStub = sinon.stub(this.oShellLayout, "getDomRef").returns(this.oShellDummy);
    ...
    function checkFooterExistInShellPage(oFooter, bBarExpected) {
        ...
        var oFooterDomNode = this.oShellDummy.querySelector("#" + this.oShellLayout.getId() + "-footer");


        if (bBarExpected) {
            assert.ok(oFooterDomNode, "The footer was rendered in the DOM.");
            assert.strictEqual(oFooterFromShell.getId().indexOf(oFooter.getId()), 0, "the page footer control existed in the ShellLayout control.");
        }
        else {
            assert.ok(oFooterFromShell === null || oFooterFromShell.getId().indexOf(oFooter.getId()) < 0, "the page footer control did not exist in the ShellLayout control.");
            assert.notEqual(oFooterDomNode.id, oFooter.getId(), "the page footer did not exist in the DOM page shell.");
        }
    }
    ...
    asyncTest("test add current state", function () {
        ...
        waitModelChanged()
            .then(function () {
                ...
                sap.ushell.Container.getRenderer("fiori2").addSubHeader("sap.ushell.ui.launchpad.ActionItem", {
                    id: "mshideGroupsBtn2"
                }, true, true);
...
/*
    ...
    test("test setFooter", function () {
        ...
        checkFooterExistInShellPage.bind(this)(footer, true);
    });
    ...
    test("test setFooter the second time", function () {
        ...
        checkFooterExistInShellPage.bind(this)(footer2, true);
        checkFooterExistInShellPage.bind(this)(footer1, false);
    ...
    test("test destroyFooter", function () {
        ...
        checkFooterExistInShellPage.bind(this)(footer, false);
    });
    ...
    test("test addUserPreferencesEntry - positive test - add entry with mandatory fields", function (assert) {
        ...
        var rendererExt = sap.ushell.renderers.fiori2.RendererExtensions;
        var userPrefEntriesArrayDefault = Config.last("/core/userPreferences/entries");
        ...
        Config.once("/core/userPreferences").do(function () {
            var userPrefEntriesArrayNew = Config.last("/core/userPreferences/entries");
    ...
    asyncTest("test addUserPreferencesEntry - positive test - add entry with all fields - check value and content arguments", function (assert) {
        function waitConfigHasOneEntry () {
            return new Promise(function (fnDone) {
                var oDoable = Config.on("/core/userPreferences/entries");
        ...
        waitConfigHasOneEntry()
            .then(function () {
                ...
                var oModel = Config.createModel("/core/userPreferences", sap.ui.model.json.JSONModel);
