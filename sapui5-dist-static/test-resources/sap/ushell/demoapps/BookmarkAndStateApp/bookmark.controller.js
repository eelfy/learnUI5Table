...
sap.ui.define([
    ...
    sap.ui.controller("sap.ushell.demo.bookmarkstate.bookmark", {
        ...
        openThemeManager: function () {
            var msgValue = '{\"type\":\"request\",\"service\":\"sap.ushell.services.UserInfo.openThemeManager\",\"body\":{},\"request_id\":\"SAPUI5_ISOLATION_MSGID_1\"}';
            window.parent.postMessage(msgValue, "*");
        }
    });
}, false);